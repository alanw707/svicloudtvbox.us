...
|---|---|---|
| `assets/images/products/svicloud-15p-marketing-v6-remote-watermarked.webp` | Local composite from the approved v2 15P feature graphic plus rendered remote source; refresh notes in `docs/15p-launch/15p-product-images-v3-remote-refresh.md` | Watermarked homepage hero, Shop card, pricing card, feature page hero, and social metadata. Alt: `SVICLOUD 15P Android 14 feature graphic with Bluetooth voice remote`. |
| `assets/images/products/svicloud-15p-primary-studio-v3-remote-watermarked.webp` | Local composite from the approved v2 15P primary studio image plus rendered remote source; refresh notes in `docs/15p-launch/15p-product-images-v3-remote-refresh.md` | Primary WooCommerce/PDP/Compare/Google Merchant image. Alt: `SVICLOUD 15P TV Box front studio view with Bluetooth voice remote`. |
