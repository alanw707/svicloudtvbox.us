...
| Approved commerce decision | `$379` regular / `$299` sale, notified backorders, and no shipping date recorded in source traceability and RPI spec |
...
| Structured data | One `$299` Product Offer with `BackOrder`; no 15P delivery-time estimate |
