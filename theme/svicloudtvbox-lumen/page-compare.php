...
if ($compare_card_15p_image_html === '') {
    $compare_card_15p_image_html = '<img src="' . esc_url(svic_theme_image_uri('/assets/images/products/svicloud-15p-front.webp')) . '" alt="' . svic_translate_attr('compare.aria.product_alt_15p') . '" loading="eager" decoding="async" />';
}
...
$compare_hero_15p_image = function_exists('svic_get_product_image_meta')
    ...
    : svic_get_theme_image_meta('/assets/images/products/svicloud-15p-front.webp');
      ...
      <div class="compare-hero__surface">
        ...
        <div class="compare-hero__devices" aria-hidden="true">
          <img
            ...
            src="<?php echo esc_url($compare_hero_15p_image['url'] ?? svic_theme_image_uri('/assets/images/products/svicloud-15p-front.webp')); ?>"
            alt=""
            loading="eager"
            decoding="async"
            fetchpriority="high"
