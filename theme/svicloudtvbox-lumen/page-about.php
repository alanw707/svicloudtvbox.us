...
$warehouse_asset_relative = '/assets/images/nevada-warehouse.png';
$warehouse_asset_path     = get_template_directory() . $warehouse_asset_relative;
$warehouse_asset_url      = file_exists($warehouse_asset_path) ? svic_theme_image_uri($warehouse_asset_relative) : '';
?>
  ...
  <section class="about-story">
    <div class="about-story__inner">
      ...
      <div class="about-story__media-stats">
        <?php if (!empty($warehouse_asset_url)) : ?>
          <figure class="about-story__media">
            <img src="<?php echo esc_url($warehouse_asset_url); ?>" alt="<?php echo esc_attr(svic_translate('about.story.warehouse_alt')); ?>" loading="lazy" width="800" height="533" />
            <figcaption class="about-story__caption"><?php echo svic_translate_html('about.story.warehouse_caption'); ?></figcaption>
          </figure>
        <?php endif; ?>
