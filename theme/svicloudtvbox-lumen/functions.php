...
function svic_render_announcement_bar(): void {
    if (function_exists('svic_render_promotion_bar') && svic_is_promotion_visible()) {
...
add_action('init', function () {
    ...
    \LiteSpeed\Purge::purge_all('SVIC disable Google promo and refresh Yogurt Mo guide');
}, 1);
...
if (!function_exists('svic_get_homepage_hero_image_meta')) {
    ...
    {
        return svic_get_theme_image_meta('/assets/images/products/svicloud-15p-marketing-v7-bilingual-remote-watermarked.webp');
    }
}
...
if (!function_exists('svic_get_15p_product_meta_definitions')) {
    ...
    function svic_get_15p_product_meta_definitions(): array
    {
        return array(
            ...
            'image'       => svic_get_theme_image_meta('/assets/images/products/svicloud-15p-primary-studio-v4-bilingual-remote-watermarked.webp'),
        );
    }
}
