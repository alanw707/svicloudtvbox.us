        ...
        return [
            'svicloud-10p-vs-10s' => [
                ...
                'sections' => [
                    ...
                    ['Trust and support', ['Official US support phone: 702-389-3416.', 'Use shipping, return, and warranty policy pages for current terms.', 'Contact support before assuming an app issue requires replacement.']],
                ],
            ],
            'best-svicloud-box-for-chinese-tv-usa' => [
                ...
                'sections' => [
                    ...
                    ['Why buy from the official US storefront', ['US-focused product guidance.', 'Support phone: 702-389-3416.', 'Canonical shipping and return policy pages.']],
                ],
            ],
            ...
            'svicloud-box-authenticity-guide' => [
                ...
                'sections' => [
                    ['Safe verification steps', ['Check official product pages and policy pages.', 'Keep order details private when asking public agents.', 'Call 702-389-3416 or use the contact page if authenticity is unclear.']],
