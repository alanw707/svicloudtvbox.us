    ...
    function svic_15p_promo_content(): array {
        $content = [
            ...
            'zh_tw' => [
                ...
                'lead' => '這是 15P 的重點頁：Android 14、Wi-Fi 6、藍牙 5.4、飛鼠操作、Filmax 本機播放，以及支援下載手機 App，包括 Yogurt TV Go 相關指引。',
                'primary_cta' => '購買 15P',
                'secondary_cta' => '比較機型',
                ...
                'faqs' => [
                    ['小雲 15P 現在能買嗎？', '可以。15P 現貨供應，特價 US$288，原價 US$379。'],
                    ['最大的實用差異是什麼？', '15P 是較新的機型，適合重視手機 App 下載、Yogurt TV Go 指引、Android 14、Wi-Fi 6 與藍牙 5.4 的買家。'],
                    ['應該選 15P 還是 10P+？', '想要最新小雲盒子，選 15P。想要已經現貨供應、成熟穩定的高階機型，選 10P+。'],
            ...
            'zh_cn' => [
                ...
                'faqs' => [
                    ['小云 15P 现在能买吗？', '可以。15P 现货供应，特价 US$288，原价 US$379。'],
                    ['最大的实用差异是什么？', '15P 是更新的机型，适合重视手机 App 下载、Yogurt TV Go 指引、Android 14、Wi-Fi 6 与蓝牙 5.4 的买家。'],
                    ['应该选 15P 还是 10P+？', '想要最新小云盒子，选 15P。想要已经现货供应、成熟稳定的高端机型，选 10P+。'],
