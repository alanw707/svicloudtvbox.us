    ...
    function svic_15p_promo_content(): array {
        $content = [
            ...
            'zh_tw' => [
                ...
                'features' => [
                    ['Android 14 平台', '比目前 10P+ 世代更新的 Android 平台，適合搜尋小雲盒子 15P 或最新小雲電視盒的買家。'],
                ...
                'compare_copy' => '如果想要現在就能出貨、成熟穩定的高階機型，選 10P+。如果想要最新小雲盒子 15P、Android 14、Wi-Fi 6、藍牙 5.4 與更強的 App 下載使用情境，選 15P。',
                'compare_rows' => [
            ...
            'zh_cn' => [
                ...
                'features' => [
                    ['Android 14 平台', '比目前 10P+ 世代更新的 Android 平台，适合搜索小云盒子 15P 或最新小云电视盒的买家。'],
                ...
                'compare_copy' => '如果想要现在就能发货、成熟稳定的高端机型，选 10P+。如果想要最新小云盒子 15P、Android 14、Wi-Fi 6、蓝牙 5.4 与更强的 App 下载使用场景，选 15P。',
                'compare_rows' => [
                    ['平台', 'Android 14', '成熟的 10P+ 平台'],
