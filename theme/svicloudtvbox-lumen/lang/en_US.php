...
return [
    ...
    'core' => [
        ...
        'cart'   => [
            'adding'             => 'Adding…',
            'added'              => 'Added to cart!',
            'added_notice'       => 'has been added to your cart',
            'view_cart'          => 'View cart',
    ...
    'frontpage' => [
        'hero' => [
            ...
            'title_separator' => '.',
            'title_tail' => '',
            'copy'    => 'Backorder the SVICLOUD 15P for $299 (regular $379) with Android 14, Amlogic S905Y5, 4 GB DDR3, 64 GB eMMC, Wi-Fi 6, Bluetooth 5.4, and 4K HDR.',
            'launch'  => [
                'badge' => 'New',
                'text'  => 'SVICLOUD 15P backorders are open',
            ],
            'showcase' => [
                'kicker'  => 'SVICLOUD 15P',
                'release' => 'Available on backorder',
        ...
        'pricing' => [
            ...
            'cards'    => [
                ...
                '10p' => [
                    ...
                    'interval' => 'device',
                    'copy'     => 'Android 12 with 4GB RAM / 64GB storage and Kids & Karaoke apps included.',
                    'features' => [
                        'hdr'    => 'Android 12 + 4K HDR + AV1 decode',
                ...
                '10s' => [
                    ...
                    'interval' => 'device',
                    'copy'     => 'Android 12 with 2GB RAM / 32GB storage—ideal for bedrooms or secondary TVs.',
                    'features' => [
                        'hdr'    => 'Android 12 + 4K HDR + AV1 decode',
    ...
    'shop' => [
        'hero' => [
            ...
            'subtitle'  => 'Explore the confirmed SVICLOUD 15P specifications, or shop current models with fast domestic shipping, 1-year warranty, and English/中文 support.',
            'highlights' => [
        ...
        'cards' => [
            ...
            '15p' => [
                ...
                'button'  => 'Backorder 15P',
                'badge'   => 'Available on backorder',
                'best_for' => 'Android 14, Wi-Fi 6, Bluetooth 5.4, and 4K codec support',
                'price_label' => 'Backorder price',
                'price_tbc'   => 'Available on backorder',
                'price_note'  => 'Shipping date not announced',
                'image_alt'   => 'SVICLOUD 15P Android 14 backorder graphic',
                ...
                'assurance' => [
                    'shipping' => 'Available on backorder',
                    'warranty' => '$299 sale · $379 regular',
                    'support'  => 'Shipping date not announced',
                ],
            ],
            '10p' => [
                'title'   => 'SVICLOUD 10P+',
                ...
                'features' => [
                    'ram_storage' => 'Android 12 + 4GB RAM / 64GB storage with AV1 decode',
            ...
            '10s' => [
                ...
                'features' => [
                    'ram_storage' => 'Android 12 + 2GB RAM / 32GB storage for everyday streaming',
                    'remote'      => '4K HDR + AV1 decode with voice remote',
                    'ports'       => 'HDMI, USB 3.0, and wired Ethernet included',
                ],
            ],
            'remote' => [
                'title'    => 'Bluetooth Remote for 10P+',
                'lead'     => 'Official replacement or second remote for SVICLOUD 10P+, shipped from U.S. inventory.',
                'button'   => 'View Remote',
                'badge'    => 'Accessory',
                'best_for' => 'Replacement remotes and multi-user households',
                'features' => [
                    'bluetooth' => 'Bluetooth 5.0 pairing with range up to 10 meters',
                    'voice'     => 'Built-in microphone for voice search',
                    'controls'  => 'Universal TV power, volume, and input controls',
                ],
            ],
        ],
    ],
    'products' => [
        ...
        'svicloud-10s' => [
            ...
            'traffic' => [
                ...
                'lead'  => 'The 10S is built for shoppers who want dependable SVICLOUD streaming, U.S. shipping, and bilingual support in a lower-cost package.',
                'bullets' => [
            ...
            'crosslink' => [
                'badge'  => 'New model',
                'title'  => 'Backorder the SVICLOUD 15P',
                'lead'   => 'The Android 14, Wi-Fi 6, and Bluetooth 5.4 SVICLOUD 15P is available on backorder for $299 (regular $379).',
                'cta'    => 'Backorder SVICLOUD 15P',
                'target' => 'svicloud-15p',
            ],
        ],
        'svicloud-9p' => [
            ...
            'crosslink' => [
                'badge'  => 'Backorder available',
                'title'  => 'Considering an upgrade from 9P?',
                'lead'   => 'Compare the confirmed 15P processor, memory, wireless, ports, and video specifications, then backorder for $299 (regular $379).',
                'cta'    => 'Backorder SVICLOUD 15P',
                'target' => 'svicloud-15p',
            ],
        ],
        'svicloud-15p' => [
            'title' => 'SVICLOUD 15P TV Box',
            'meta' => [
                'title'       => 'SVICLOUD 15P Backorder $299 | Android 14 TV Box',
                'description' => 'Backorder SVICLOUD 15P for $299 (regular $379). Android 14, Amlogic S905Y5, 4 GB DDR3, 64 GB eMMC, Wi-Fi 6, Bluetooth 5.4, and 4K HDR.',
                'image_alt'   => 'SVICLOUD 15P TV box front view',
            ],
            'short_description' => 'Available on backorder for $299 (regular $379) with Android 14, Amlogic S905Y5, 4 GB DDR3, 64 GB eMMC, Wi-Fi 6, Bluetooth 5.4, and 4K HDR.',
            'description' => '<p>The SVICLOUD 15P TV Box runs Android 14 on an Amlogic S905Y5 quad-core ARM Cortex-A55 processor.</p><h2>Core specifications</h2><ul><li>4 GB DDR3 memory and 64 GB eMMC storage.</li><li>Dual-band 2.4/5 GHz Wi-Fi 6 with 2T2R and Bluetooth 5.4.</li><li>HDR10+, HDR10, and HLG picture processing.</li><li>AV1, VP9, H.265/HEVC, and H.264 hardware decoding, with AV1, VP9, and H.265/HEVC support up to 4K × 2K at 60 fps.</li><li>HDMI 2.1, two USB 2.0 ports, RJ45 Ethernet, optical audio, and Type-C 5V/2A power.</li></ul><h2>In the box</h2><p>Gift box, AC adapter, HDMI cable, Bluetooth voice air-mouse remote, and user manual.</p><p><strong>Available on backorder for $299 (regular $379).</strong> Shipping date not announced.</p>',
            'footer' => [
                'tagline' => 'SVICLOUD 15P backorder information',
                'summary' => 'Source-confirmed 15P hardware with a $299 backorder price (regular $379). Shipping date not announced.',
                'badges' => [
                    'coming_soon'   => 'Available on backorder',
                    'specifications'=> 'Hardware specifications available',
                    'commerce'      => '$299 sale · $379 regular',
                ],
                'benefits' => [
                    'platform' => [
                        'label'       => 'Confirmed platform',
                        'description' => 'Android 14, Amlogic S905Y5, 4 GB DDR3, and 64 GB eMMC.',
                    ],
                    'connectivity' => [
                        'label'       => 'Confirmed connectivity',
                        'description' => 'Dual-band Wi-Fi 6, Bluetooth 5.4, RJ45, HDMI 2.1, optical audio, and Type-C power.',
                    ],
                    'availability' => [
                        'label'       => 'Backorder status',
                        'description' => 'Available on backorder for $299; shipping date not announced.',
                    ],
                ],
            ],
            'inbox' => [
                'items' => [
                    'box'    => 'SVICLOUD 15P TV box',
                    'power'  => 'AC adapter (plug variant not specified)',
                    'hdmi'   => 'HDMI cable',
                    'remote' => 'Bluetooth voice air-mouse remote',
                    'manual' => 'User manual',
                ],
            ],
            'prelaunch' => [
                'subtitle' => 'Available on backorder with Android 14, Amlogic S905Y5, Wi-Fi 6, Bluetooth 5.4, and 4K HDR.',
                'detail'   => '$299 sale · $379 regular · Shipping date not announced',
                ...
                'highlights' => [
                    'specs'        => 'Amlogic S905Y5 quad-core ARM Cortex-A55 processor',
                    'availability' => 'Dual-band Wi-Fi 6 with 2T2R + Bluetooth 5.4',
                    'policy'       => 'HDR10+/HDR10/HLG + AV1 hardware decoding',
                ],
                'reassurance' => [
                    'badge' => 'Verified product details',
                    'title' => 'Confirmed 15P hardware at a glance',
                    'copy'  => 'Review the verified hardware and in-box accessories before placing a $299 backorder. Shipping date not announced.',
                    'bullets' => [
                        'shipping'  => 'Android 14 with Amlogic S905Y5 processing',
                        'warranty'  => '4 GB DDR3 memory + 64 GB eMMC storage',
                        'concierge' => 'Wi-Fi 6, Bluetooth 5.4, 4K HDR, and AV1 decoding',
                    ],
                ],
                'faq_header' => [
                    'badge' => '15P backorder information',
                    'title' => 'Confirmed specifications and backorder details',
                    'lead'  => 'The supplied files confirm the listed hardware and package contents. Backorders are $299 (regular $379); shipping date not announced.',
                ],
                'faq' => [
                    'specs' => [
                        'q' => 'What are the confirmed SVICLOUD 15P specifications?',
                        'a' => 'The 15P uses Android 14, an Amlogic S905Y5 quad-core ARM Cortex-A55 processor, 4 GB DDR3 memory, 64 GB eMMC storage, dual-band Wi-Fi 6, Bluetooth 5.4, and hardware decoding for AV1 and other major codecs.',
                    ],
                    'availability' => [
                        'q' => 'Can I order the SVICLOUD 15P now?',
                        'a' => 'Yes. The 15P is available on backorder for $299 (regular $379). Shipping date not announced.',
                    ],
                    'policy' => [
                        'q' => 'What comes with the SVICLOUD 15P?',
                        'a' => 'The source package list includes the TV box, AC adapter, HDMI cable, Bluetooth voice remote, user manual, and gift box. A particular plug variant is not promised.',
                    ],
                ],
            ],
            'best_for' => [
                'badge' => 'Confirmed platform',
                'title' => 'Android 14 with Wi-Fi 6 and Bluetooth 5.4',
                'copy'  => 'The supplied specification lists Android 14, Amlogic S905Y5, dual-band Wi-Fi 6, Bluetooth 5.4, and the stated 4K codec support.',
                'bullets' => [
                    'primary'   => '4 GB DDR3 memory and 64 GB eMMC storage',
                    'secondary' => 'Dual-band Wi-Fi 6, RJ45 Ethernet, and Bluetooth 5.4 connectivity',
                    'tertiary'  => '4K HDR playback with AV1, VP9, H.265/HEVC, and H.264 hardware decoding',
                ],
            ],
            'traffic' => [
                'badge' => 'Inside the SVICLOUD 15P',
                'title' => 'Android 14 with the listed wired and wireless connections',
                'lead'  => 'The 15P specification lists AV1, VP9, H.265/HEVC, H.264, dual-band Wi-Fi 6, Bluetooth 5.4, HDMI 2.1, RJ45, optical audio, USB, and Type-C power.',
                'bullets' => [
                    'shipping'  => 'HDMI 2.1, two USB 2.0 ports, RJ45 Ethernet, optical audio, and Type-C power',
                    'concierge' => 'Bluetooth voice air-mouse remote plus HDMI CEC TV control',
                    'warranty'  => 'HDR10+, HDR10, HLG, AV1, VP9, H.265/HEVC, and H.264 support',
                ],
            ],
            'comparison' => [
                'badge' => 'Compare models',
                'title' => 'SVICLOUD 15P vs 10P+ vs 9P',
                'lead'  => 'Compare the confirmed 15P specifications with existing models without assigning a performance ranking.',
                'cards' => [
                    'vs_10p' => [
                        'title'   => '15P vs 10P+',
                        'summary' => 'Both list 4 GB / 64 GB configurations; choose based on confirmed platform features and whether you need a model available now.',
                        'bullets' => [
                            ...
                            'three' => '15P: available on backorder for $299 (regular $379); shipping date not announced',
                        ],
                        'link_label' => 'See the SVICLOUD 10P+',
                    ],
                    'vs_9p' => [
                        'title'   => '15P vs 9P',
                        'summary' => 'The 15P source lists Android 14 and Wi-Fi 6; it does not provide a measured performance comparison with 9P.',
                        'bullets' => [
                            ...
                            'three' => 'Compare the $299 backorder offer with your current 9P before deciding',
                        ],
                ...
                'upgrade' => [
                    ...
                    'items' => [
                        ...
                        'new_buyer' => '15P is available on backorder for $299 (regular $379); current models remain separately available.',
                    ],
                ],
                'assurance' => [
                    ...
                    'items' => [
                        ...
                        'support'  => 'Backorder price: $299 sale, $379 regular; shipping date not announced',
    ...
    'compare' => [
        'meta' => [
            ...
            'description' => 'Compare the $299 SVICLOUD 15P backorder ($379 regular) with 10P+ and 10S hardware, storage, connectivity, video support, pricing, and availability.',
            'image_alt'   => 'SVICLOUD 15P, 10P+, and 10S streaming boxes',
        ],
        'hero' => [
            'badge'    => 'Compare Models',
            'title'    => 'SVICLOUD 15P vs 10P+ vs 10S',
            'subtitle' => 'Compare the $299 15P backorder with current 10P+ and 10S pricing, specifications, and availability.',
        ],
        'traffic' => [
            'badge' => 'Buy with confidence in the U.S.',
            'title' => 'Compare a 15P backorder with models available from U.S. inventory',
            'lead'  => '15P is available on backorder for $299 (regular $379), with no announced shipping date. Current 10P+ and 10S purchases retain their published fulfillment and support terms.',
            'bullets' => [
        ...
        'differences' => [
            'next_generation' => [
                ...
                'description' => '15P combines Android 14, Amlogic S905Y5, dual-band Wi-Fi 6, and Bluetooth 5.4 with a $299 backorder price.',
            ],
            'premium_performance' => [
        ...
        'products' => [
            '15p' => [
                'lead'     => 'Available on backorder with Android 14, Wi-Fi 6, Bluetooth 5.4, and the specified 4K codecs.',
                'fit_label'=> 'Backorder available',
                'fit_copy' => 'Android 14, Amlogic S905Y5, dual-band Wi-Fi 6, Bluetooth 5.4, and listed 4K codec support for $299 (regular $379).',
                'bullets' => [
        ...
        'confidence' => [
            ...
            'lead'  => 'Use confirmed specifications and prices to compare all three models. 15P is available on backorder; shipping date not announced.',
            'cards' => [
                'official' => [
                ...
                'shipping' => [
                    ...
                    'copy'  => 'Currently purchasable models leave from U.S. inventory with tracking and local setup accessories.',
                ],
                'concierge' => [
                ...
                'warranty' => [
                    ...
                    'copy'  => 'Normal checkout and return policies apply; no 15P-specific shipping-speed, delivery-date, or warranty promise is made.',
                ],
            ],
            'timeline' => [
        ...
        'comparison' => [
            ...
            'rows'  => [
                'processor' => [
                    'label' => 'Processor',
                    'p15p'  => 'Amlogic S905Y5 quad-core Cortex-A55',
                    'p10p'  => 'Amlogic S928X octa-core',
                    'p10s'  => 'Quad-core processor',
                ],
                'ram_storage' => [
                    'label' => 'RAM / Storage',
                ...
                'connectivity' => [
                    'label' => 'Connectivity',
                    'p15p'  => 'Wi-Fi 6 2T2R, Bluetooth 5.4, RJ45',
                    'p10p'  => 'Wi-Fi 6, Bluetooth voice remote, Gigabit LAN',
                    'p10s'  => 'Dual-band Wi-Fi, Bluetooth, Ethernet',
                ],
                'video_quality' => [
                    'label' => 'Video Quality',
                    'p15p'  => '4K HDR10+/HDR10/HLG, AV1 decode',
                    'p10p'  => '4K HDR, AV1 decode',
                    'p10s'  => '4K HDR, AV1 decode',
                ],
                'voice_remote' => [
                    'label' => 'Voice Remote',
                    'p15p'  => 'Bluetooth voice air-mouse remote included',
                    'p10p'  => 'Included',
                    'p10s'  => 'Included',
                ],
                'kids_app' => [
                ...
                'best_for' => [
                    ...
                    'p15p'  => 'Android 14, Wi-Fi 6, Bluetooth 5.4; Backorder $299',
        ...
        'final_cta' => [
            ...
            'cta_15p' => 'Backorder SVICLOUD 15P',
        ],
        'sticky_buy' => [
