    ...
    'return_policy' => [
        'sections' => [
            'damage' => [
                'title' => '硬件保修与人为损坏',
                'items' => [
                    'coverage' => '我们的一年美国硬件保修涵盖正常使用下的制造缺陷。',
                    'eligibility' => '人为造成的损坏不在保修范围内，恕不退款，亦不提供免费维修或更换，法律另有规定者除外。',
                    'assessment' => '我们会评估损坏申请后判定保修范围，并说明判定结果及可提供的处理方式。',
                ],
            ],
        ],
    ],
  ...
  <li>想要礼宾服务与最新韧体，但预算更精简。</li>
    ...
    'frontpage' => [
        ...
        'certification' => [
            ...
            'lead' => 'SVI.STUDIO 正式授权 168 Media Group LLC（SVICLOUDTVBOX.US）作为 SVI.STUDIO 系列产品的区域批发及销售经销商。',
            'meta' => [
                'number' => [
                    'label' => '授权编号',
