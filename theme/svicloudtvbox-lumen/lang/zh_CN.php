    ...
    'guides' => [
        ...
        'troubleshooting' => [
            ...
            'items' => [
                'remote' => [
                    'title' => '遥控器无法配对',
                    'copy'  => '取出电池，等待 10 秒后重新装回，靠近机身 1 公尺内，同时按住 <kbd>VOL-</kbd> + <kbd>VOL+</kbd> 3 秒，直到 LED 闪烁并看到配对成功提示。若仍失败，请更换新的 AAA 电池。',
                ],
                'streaming' => [
                    'title' => '画面模糊或不断缓冲',
                    'copy'  => '建议改用网路线连接以获得最稳定的速度。若使用 Wi-Fi，请连接 5 GHz 频段，并将机器移至靠近路由器的位置，避免放在电视后方。持续缓冲时请重启路由器。建议带宽至少 15 Mbps 以确保 4K 流畅播放。',
                ],
                'no_signal' => [
                    'title' => '电视显示「无信号」',
                    'copy'  => '确认电视已切换至正确的 HDMI 输入孔。从两端拔除 HDMI 线，等待 10 秒后重新插紧。也可尝试电视上的其他 HDMI 插孔。若使用 AV 扩大机或 Soundbar 中继，请先直接连接电视，排除设备问题。',
                ],
                'wifi_disconnect' => [
                    'title' => 'Wi-Fi 持续断线',
                    'copy'  => '前往 <strong>设置 > 网络</strong>，先忘记目前的 Wi-Fi，再重新连线。建议选择 5 GHz 频段以减少干扰。若路由器支援 Wi-Fi 6，请确认已启用。避免将机器放在微波炉、婴儿监控器或其他 2.4 GHz 设备附近。建议最终改用 Ethernet 有线连接。',
                ],
                'audio_sync' => [
                    'title' => '音效不同步或无声',
                    'copy'  => '前往 <strong>设置 > 显示与音效</strong>，若使用电视喇叭请选择 PCM；若使用 Soundbar 或 AV 扩大机则选 Auto 或 Passthrough。可尝试关闭再开启 HDMI CEC。若音效有延迟，请更换 HDMI 线或插孔。重启机器通常可解决暂时性的同步问题。',
                ],
                'frozen' => [
                    'title' => '机器当机或无回应',
                    'copy'  => '按住机身电源键 8 秒强制重启。若遥控器也无反应，请拔除电源适配器，等待 30 秒后重新插上。若频繁当机，可能需要更新韧体，或机器过热——请确保机器四周保持良好散热空间。',
                ],
                'firmware' => [
                    'title' => '如何更新韧体',
                    'copy'  => '前往 <strong>设置 > 关于 > 系统更新</strong>，点选「检查更新」。机器须连线至网路，更新约需 3 至 5 分钟。更新期间请<strong>切勿</strong>拔除电源。若未显示更新，表示韧体已是最新版本。遇到错误讯息请联系礼宾服务。',
                ],
                'voice_remote' => [
                    'title' => '语音搜寻无法使用',
                    'copy'  => '请确认遥控器已透过蓝牙配对（而非仅使用红外线）。按住麦克风键并在手臂可及的距离内清楚说话。若无反应，请至 <strong>设置 > 遥控器与配件</strong> 重新配对。语音搜寻需要网路连线，韧体更新期间可能暂时无法使用。',
                ],
                'hdmi_resolution' => [
                    'title' => '画面比例错误或被裁切',
                    'copy'  => '前往 <strong>设置 > 显示与音效 > 解析度</strong>，选择「自动」或符合电视原生解析度（通常为 4K/2160p）。若画面过度放大，请在电视端将画面比例设为「点对点」、「1:1」或「Just Scan」（依电视品牌不同）。请关闭电视的任何缩放模式。',
                ],
                'orz' => [
                    'title' => '串流 App 无法开启',
                    'copy'  => '确认该 App 来自合法授权平台。前往 <strong>设置 > 应用程序</strong> 清除快取后重新开启。若 App 持续闪退，请移除后重新安装。第三方或未授权 App 的问题超出我们的支援范围，请直接联系该 App 的客服。',
                ],
            ],
        ],
        'resources' => [
