...
$overrides = [
    ...
    'guides' => [
        ...
        'apps' => [
            ...
            'lead'  => '如果找不到 App、App 无法打开，或第一次设定后需要重新安装，请依照这份公开清单操作。客户专属的安装来源与代码，请查看下单后收到的设定教学 Email。',
            'items' => [
                'internet' => [
                    'title' => '1. 确认电视盒已连上网络',
                    'copy'  => '打开「设置 → 网络」，确认 Wi-Fi 或 Ethernet 显示已连接。若网络不稳，请先重启路由器或改用网线。',
                ],
                'installer' => [
                    'title' => '2. 打开内建浏览器或安装器',
                    'copy'  => '从主画面打开内建浏览器、App 市场、App 中心，或客户设定 Email 内指定的安装器。请不要使用搜寻结果中的陌生下载连结。',
                ],
                'search' => [
                    'title' => '3. 依照客户设定 Email 操作',
                    'copy'  => '下单后的设定 Email 会提供客户专属安装来源与正确 App 名称（如订单需要）。请完全照着输入，安装前确认 App 图示。',
                ],
                'install' => [
                    'title' => '4. 安装或更新 App',
                    'copy'  => '选择 Install 或 Update，等待进度完成后再回到主画面。安装过程中请不要拔电源。',
                ],
                'open' => [
                    'title' => '5. 打开 App 并完成第一次启动',
                    'copy'  => '第一次打开 App 时，依画面提示允许必要权限并完成初始设定。若画面要求帐号或启用资讯，请依照客户 Email 内的说明操作。',
                ],
                'support' => [
                    'title' => '6. 还是卡住？请拍照给客服',
                    'copy'  => '如果 App 无法安装或出现错误讯息，请直接回覆设定 Email，附上电视画面照片与订单编号，我们会协助判断。',
                ],
            ],
        ],
        'post_setup' => [
