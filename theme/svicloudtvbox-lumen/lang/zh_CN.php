...
$overrides = [
    'return_policy' => [
        'sections' => [
            'damage' => [
                'title' => '硬件保修与人为损坏',
                'items' => [
                    'coverage' => '我们的一年美国硬件保修涵盖正常使用下的制造缺陷。在法律允许的范围内，不涵盖因误用、意外、液体侵入、不当连接、过度用力或未经授权的维修或改装所造成的损坏。不得仅因设备曾被改装，就排除与改装无关的缺陷。',
                    'examples' => '例如：强行插入接头、以错误方向插入，或未取下接头保护套便插入，导致接口、接头外壳、接脚或内部防尘盖损坏。但零件松脱或破损本身，并不足以判定为人为损坏。',
                    'eligibility' => '人为造成的损坏不适用免费保修维修、更换，或一般改变主意退货政策下的退款。制造缺陷与由本店造成的损坏另行评估；适用的法定消费者权益不受影响。',
                    'assessment' => '我们会审阅问题描述、照片、制造商意见，并在必要时进行实物检查后判定保修范围。我们会说明判定依据及可提供的处理方式。收到寄回说明前，请勿自行寄回设备。',
                    'costs' => '若可提供付费维修或其他付费服务，我们会事先说明费用、任何检查费及运费责任，经您同意后才进行。非缺陷退货最高 10% 的整新费并非损坏鉴定费。',
                    'existing' => '既有订单仍按购买时提供的条款及适用法律处理。本次更新不追溯变更既有订单的条款。',
                ],
            ],
        ],
    ],
    ...
    'guides' => [
        ...
        'troubleshooting' => [
            'badge' => '',
            'title' => 'SVICLOUD 15P 疑难排解',
            'lead' => '先选择您的 15P 症状。每次只做一项检查，再测试是否恢复。请勿一开始就恢复出厂设置。',
            'intro_title' => '从这里开始：选择症状',
            'intro_copy' => '本页优先协助 15P 用户。菜单名称可能因固件或 App 版本不同而改变。配对、复原与电源供应器操作，请依您的确切型号说明或联系客服。',
            'older_title' => '使用 10P+、10S 或其他旧型号？',
            'older_copy' => '上方基本网络、HDMI 与 App 检查也可能适用。配对按键、复原步骤、电源供应器与 App 支援因型号而异，请勿将 15P 专用程序套用到旧机。请提供型号，让客服确认正确步骤。',
            'support_title' => '仍然无法解决？',
            'support_copy' => '请寄信至 support@svicloudtvbox.us，附上型号、订单编号、错误照片、发生时间及已尝试的步骤。网络问题请注明有线网络或手机热点的测试结果。请勿提供密码或付款数据。',
            'email_label' => '寄信给客服',
            'items' => [
                'remote' => [
                    'title' => '遥控器按键或语音无反应',
                    'copy' => '<ol><li>检查电池方向并尝试新电池。将遥控器朝向盒子，移开遮挡物。</li><li>红外线电源键可用，不代表蓝牙已配对。若方向键或语音失效，请依 15P 随附说明检查连线，不要猜测配对按键组合。</li><li>若反复断开配对，或换过遥控器仍有相同问题，请停止反复重设，提供型号及短片给客服。</li></ol>',
                ],
                'streaming' => [
                    'title' => '播放缓冲或画质下降',
                    'copy' => '<ol><li>比较其他频道或影片，再试另一个 App。只有一个来源出问题，可能与该来源有关，但不能证明盒子或网络完全正常。</li><li>可用时改用有线网络，或把盒子移近路由器。暂停其他大量下载后再测试。</li><li>连线稳定度、服务与影片画质都会影响播放；单一网速不能保证流畅 4K。仍有问题时，请提供 App、频道或片名及发生时间。</li></ol>',
                ],
                'no_signal' => [
                    'title' => '电视显示无讯号或黑画面',
                    'copy' => '<ol><li>确认盒子已供电，且电视切到对应的 HDMI 输入。</li><li>关闭设备电源后重新接好 HDMI 线。尝试另一条已知正常的线或电视 HDMI 插孔。</li><li>若经过功放或回音壁，先将盒子直接接电视测试。仍无画面时，请先联系客服，不要自行进入复原或重设。</li></ol>',
                ],
                'wifi_disconnect' => [
                    'title' => 'Wi-Fi 断线或已连线但无互联网',
                    'copy' => '<ol><li>检查同一网络的其他设备能否上网。若也失败，可重新启动路由器。</li><li>先确认 Wi-Fi 密码，再忘记网络并重新连线。靠近路由器测试，或改用有线网络。</li><li>若移动数据额度允许，可短暂比较手机热点。结果不同表示与网络环境有关，不能直接认定是业者封锁或 DNS 故障。请勿盲目修改固定 IP。</li></ol>',
                ],
                'audio_sync' => [
                    'title' => '没有声音或声画不同步',
                    'copy' => '<ol><li>检查静音、电视或回音壁输入，并以舒适音量测试其他 App 或影片。</li><li>先以 HDMI 直接连电视，排除回音壁或功放影响。若有音频格式选项，可记下原设置，再试 PCM 兼容性测试。</li><li>若有延迟，检查电视或回音壁的声画同步设置。仍有问题时，提供连接方式及 App 名称给客服。</li></ol>',
                ],
                'app_cache' => [
                    'title' => 'App 闪退：清除缓存还是数据？',
                    'copy' => '<ol><li>关闭并重新开启该 App。盒子仍可操作时，可正常重新启动。</li><li>在 App 设置中，若有清除缓存选项，可先清除再测试。缓存是临时文件；清除数据或储存空间可能移除登录与 App 设置。</li><li>尚未确认如何恢复 App 与账号前，不要清除数据、解除安装或恢复出厂设置。持续闪退时，请提供 App 版本与错误信息。</li></ol>',
                ],
                'stuck_loading' => [
                    'title' => '当机、停在标志或进入 Recovery',
                    'copy' => '<ol><li>若正在更新，请勿中断电源。否则先关机，拔电 2–3 分钟并移除外接 USB 配件，再接回原厂电源供应器及 HDMI。</li><li>保持通风。停在标志与反复重新启动是不同症状，请记录您看到的情况。</li><li>若再次进入 Recovery 或仍卡住，请拍照给客服。不要把物品插入插孔，或使用其他型号的复原程序。恢复出厂设置会删除 App、账号与设置，请先取得型号对应指引。</li></ol>',
                ],
                'firmware' => [
                    'title' => '找不到固件更新或更新失败',
                    'copy' => '<ol><li>在网络正常时，使用盒子提供的系统更新功能。菜单名称可能因固件版本不同而异。</li><li>更新中保持供电。请勿安装其他型号的固件。</li><li>没有显示更新，不代表一定是最新版本。不确定时，请提供 15P 型号、目前版本与错误照片给客服，不要反复重试失败的更新。</li></ol>',
                ],
                'download_ssl' => [
                    'title' => 'Yogurt TV 下载失败或显示 SSL 错误',
                    'copy' => '<ol><li>检查网络及盒子的日期时间。使用 App 安装指南，或请客服确认目前安装网址；不要使用来路不明的 APK。</li><li>若网页能开但下载失败，可在移动数据额度允许时试一次手机热点。此方式曾解决旧型号客服案例，但不能保证解决 15P 问题。</li><li>若热点成功但家中 Wi-Fi 失败，可向路由器或网络业者客服查询安全警示，仍不能据此确定原因。不要因下载错误反复恢复出厂设置；请提供完整错误及测试结果。</li></ol>',
                ],
                'optical_fit' => [
                    'title' => '光纤音频线插不稳',
                    'copy' => '<ol><li>TOSLINK 是光纤音频连接。确认接头方向并取下保护帽，再轻轻插入；请勿用力硬推。</li><li>若手边已有另一条标准 TOSLINK 线，只在完好的插孔轻试。不必为排查特地买线。</li><li>若挡片松脱、接头无法固定或插孔看似损坏，请停止并提供插孔与接头照片。不要自行装回挡片，也不要假设换机一定能解决插合问题。</li></ol>',
                ],
                'yogurt_mo' => [
                    'title' => 'Android 手机或平板使用 Yogurt Mo',
                    'copy' => '<ol><li>Yogurt Mo 移动观看是 15P 功能，不适用 8P 或 10 系列的安装流程。支援兼容的 Android 手机及平板，不支援 iPhone 或 iPad。</li><li>在 15P 开启 Yogurt TV，选择 Bind（绑定），再用要使用的 Android 手机或平板扫描 QR 码。设备请连接同一家庭网络。</li><li>若绑定失败，请提供 Android 版本与错误给客服。不要公开授权资讯或 QR 码。</li></ol>',
                ],
            ],
        ],
        'resources' => [
  ...
  <li>想要礼宾服务与最新韧体，但预算更精简。</li>
    ...
    'frontpage' => [
        'hero' => [
            ...
            'title_separator' => '。',
            'title_tail' => '',
            'copy'    => 'SVICLOUDTVBOX.US 由 168 Media Group LLC 经营，提供原厂授权证明、内华达发货与中英双语协助。小云 15P 现以 US$288 现货供应（原价 US$379），搭载 Android 14、Amlogic S905Y5、4 GB DDR3、64 GB eMMC、Wi-Fi 6、蓝牙 5.4 与 4K HDR。',
            'launch'  => [
                'badge' => '新品',
                'text'  => '小云 15P 现货供应中',
            ],
    ...
    'compare' => [
        ...
        'confidence' => [
            ...
            'cards' => [
                ...
                'warranty' => [
                    'title' => '购买后仍有保修',
                    'copy'  => '退货资格请见本店公开政策；特定机型的保修范围请向客服确认。',
                ],
            ],
            'timeline' => [
                'badge' => '订单流程',
