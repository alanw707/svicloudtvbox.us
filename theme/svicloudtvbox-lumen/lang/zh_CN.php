...
$overrides = [
    ...
    'recent_shipments' => [
        ...
        'disclaimer'             => '依据近期美国出货标签与承运商预估时程整理。实际送达仍会因目的地、周末与假期而有所不同。',
        'item'                   => '{{state}} · 预计 {{time}}',
        'item_title'             => '近期承运服务：{{service}}',
    ...
    'products' => [
        'svicloud-10p-plus' => [
            ...
            'description' => '<p>小云电视盒 10P+ 是家庭客厅的旗舰机，结合语音操控、卡拉 OK 与最快的硬件性能。</p><ul><li>4GB 内存与 64GB 存储、AV1 解码，直播体育赛事与戏剧都能流畅 4K 播放。</li><li>内建儿童模式与卡拉 OK 应用，附英文 / 中文礼宾带领完成设置。</li><li>标配 Wi-Fi 6、Gigabit 有线网络、蓝牙语音遥控、USB 3.0 与扩展端口，满足多种安装场景。</li><li>美国内华达州仓库配送，30 天安心退换、一年美国保修与真人礼宾客服。</li></ul><p>盒内附 HDMI 线、电源适配器、语音遥控，支持双无线麦克风卡拉 OK。</p>',
            'best_for' => [
                'badge' => '最适合',
