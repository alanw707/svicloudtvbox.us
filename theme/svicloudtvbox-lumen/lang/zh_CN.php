...
$overrides = [
    ...
    'guides' => [
        ...
        'apps' => [
            ...
            'lead'  => '如果找不到 App、App 无法打开，或第一次设定后需要重新安装，请依照这份清单操作。请只从可信任的官方来源安装 App。',
            'items' => [
                'internet' => [
                    'title' => '1. 确认电视盒已连上网络',
                ...
                'installer' => [
                    'title' => '2. 打开 App Market 或安装器',
                    'copy'  => '从主画面打开内建 App 市场、App 中心，或小云电视盒提供的官方安装器。',
                ],
                'search' => [
                    'title' => '3. 搜寻 App 名称',
                    'copy'  => '使用萤幕键盘或语音遥控搜寻。安装前请确认 App 图示与发行者，避免装错。',
                ],
                'install' => [
                    'title' => '4. 安装或更新 App',
                ...
                'open' => [
                    'title' => '5. 打开 App 并视需要登入',
                    'copy'  => '第一次打开 App 时，依画面提示允许必要权限；若服务需要帐号，请使用自己的帐号登入。',
                ],
                'support' => [
                    'title' => '6. 还是卡住？请拍照给客服',
                    'copy'  => '如果 App 无法安装或出现错误讯息，请将画面照片与订单编号传给礼宾客服，我们会协助判断。',
                ],
            ],
        ],
        'post_setup' => [
