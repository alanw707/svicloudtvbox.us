...
$overrides = [
    ...
    'frontpage' => [
        ...
        'confidence' => [
            ...
            'cards' => [
                ...
                'warranty' => [
                    'title' => '保修与退换货清楚',
                    'copy'  => '每台设备皆含 1 年美国硬件保修与 30 天退换货期间。',
                ],
            ],
            'timeline' => [
                'badge' => '下单之后',
    ...
    'product' => [
        'hero' => [
            ...
            'reassurance' => [
                ...
                'bullets' => [
                    ...
                    'warranty'  => '附 1 年美国保修与 30 天退换货，由礼宾客服协助处理',
        ...
        'accessories' => [
            'badge'    => '配件',
            'title'    => '升级你的设置',
            'subtitle' => '以官方蓝牙遥控器让 10P+ 体验更完整 — 单独贩售，从内华达州发货。',
            'product'  => [
                'badge'   => '新品',
                'title'   => '小云电视盒 10P+ 蓝牙电视遥控器',
                'copy'    => '专为 SVICLOUD 10P+ 设计的官方替换或备用蓝牙语音遥控。几秒内完成配对，支持语音搜索，并可控制电视音量和开关机。',
                'features' => [
                    'bt'     => 'Bluetooth 5.0 — 快速、稳定配对',
                    'voice'  => '内置麦克风支持语音搜索与助理指令',
                    'compat' => '通用电视开关机与音量控制键',
                ],
                'cta'         => '选购遥控器',
                'details_cta' => '查看详情',
                'price_note'  => '从内华达州发货 · 美国免运费',
            ],
        ],
    ],
    'products' => [
        ...
        'svicloud-bluetooth-remote-10p-plus' => [
            'short_description' => '小云电视盒 10P+ 官方蓝牙遥控器。Bluetooth 5.0 配对、语音搜索麦克风与通用电视开关机/音量键。美国现货发货。',
            'description' => '<p>小云电视盒 10P+ 蓝牙电视遥控器是专为多人共用电视的家庭设计的官方替换或备用遥控器。只需按住 VOL- 和 VOL+ 键，几秒内即可与 10P+ 完成配对，无需额外 App 或设置页面。</p><ul><li>Bluetooth 5.0 提供最远 10 米的快速、稳定配对体验。</li><li>内置麦克风支持语音搜索指令与助理快捷键。</li><li>通用电视键可直接从遥控器控制电视开关机、音量与输入来源。</li><li>背光数字键盘与媒体键让夜间操作更舒适。</li><li>仅适用于 SVICLOUD 10P+。从内华达州发货，美国境内免费配送。</li></ul>',
            'best_for' => [
                'badge' => '最适合',
                'title' => '需要替换或备用遥控器的 10P+ 用户',
                'copy'  => '为多人共用电视的家庭配备一支备用遥控，或用完全相同的蓝牙语音遥控替换丢失的那支。',
                'bullets' => [
                    'primary'   => '与 10P+ 随附遥控完全相同的替换品',
                    'secondary' => '非常适合多人共用同一台电视的家庭',
                    'tertiary'  => '美国免运费发货，享有标准退换货保障',
                ],
            ],
        ],
        'svicloud-10s' => [
            ...
            'traffic' => [
                ...
                'bullets' => [
                    ...
                    'warranty'  => '1 年美国保修 + 30 天退换货，礼宾客服协助处理',
                ],
            ],
        ],
    ],
    'compare' => [
        'meta' => [
            'title'       => '小云盒子 10P+ 和 10S 比较｜美国购买前先看规格差异',
            'description' => '比较小云盒子 10P+ 与 10S 的规格、功能、价格与适用场景，帮你在美国购买前快速选出最适合的机型。',
        ...
        'confidence' => [
            ...
            'cards' => [
                ...
                'warranty' => [
                    'title' => '购买后仍有保修',
                    'copy'  => '两款机型皆包含 1 年美国保修与 30 天退换货期间。',
                ],
            ],
            'timeline' => [
                'badge' => '订单流程',
