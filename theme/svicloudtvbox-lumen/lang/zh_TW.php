...
return [
    ...
    'guides' => [
        ...
        'apps' => [
            ...
            'lead'  => '如果找不到 App、App 無法開啟，或第一次設定後需要重新安裝，請依照這份清單操作。請只從可信任的官方來源安裝 App。',
            'items' => [
                'internet' => [
                    'title' => '1. 確認電視盒已連上網路',
                ...
                'installer' => [
                    'title' => '2. 開啟 App Market 或安裝器',
                    'copy'  => '從主畫面開啟內建 App 市場、App 中心，或小雲電視盒提供的官方安裝器。',
                ],
                'search' => [
                    'title' => '3. 搜尋 App 名稱',
                    'copy'  => '使用螢幕鍵盤或語音遙控搜尋。安裝前請確認 App 圖示與發行者，避免裝錯。',
                ],
                'install' => [
                    'title' => '4. 安裝或更新 App',
                ...
                'open' => [
                    'title' => '5. 開啟 App 並視需要登入',
                    'copy'  => '第一次開啟 App 時，依畫面提示允許必要權限；若服務需要帳號，請使用自己的帳號登入。',
                ],
                'support' => [
                    'title' => '6. 還是卡住？請拍照給客服',
                    'copy'  => '如果 App 無法安裝或出現錯誤訊息，請將畫面照片與訂單編號傳給禮賓客服，我們會協助判斷。',
                ],
            ],
        ],
        'post_setup' => [
