    ...
    'return_policy' => [
        ...
        'sections' => [
            'damage' => [
                'title' => '硬體保固與人為損壞',
                'items' => [
                    'coverage' => '我們的一年美國硬體保固涵蓋正常使用下的製造瑕疵。',
                    'eligibility' => '人為造成的損壞不在保固範圍內，恕不退款，亦不提供免費維修或更換，法律另有規定者除外。',
                    'assessment' => '我們會評估損壞申請後判定保固範圍，並說明判定結果及可提供的處理方式。',
                    'existing' => '既有訂單仍依購買時提供的條款及適用法律處理。',
                ],
            ],
            'eligibility' => [
                'title' => '申請前請先確認資格',
