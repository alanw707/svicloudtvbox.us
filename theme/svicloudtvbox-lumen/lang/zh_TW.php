...
return [
    ...
    'frontpage' => [
        'hero' => [
            'badge'   => '美國授權經銷 · 內華達',
            'title'   => '全新小雲 15P 即將登場。亞洲娛樂，重新想像。',
            'title_lead' => '全新小雲 15P 即將登場',
            'title_separator' => '。',
            'title_tail' => '亞洲娛樂，重新想像。',
            'copy'    => '小雲 15P 上市預覽。規格、內容、價格、美國到貨、費用、保固與客服均待確認；10P+ 與 10S 現有資料可立即查看。',
            'launch'  => [
                'badge' => '新品',
                'text'  => '小雲 15P 上市資料待確認',
            ],
            'showcase' => [
                ...
                'release' => '2026 新品',
                'title'   => '全新旗艦，即將登場。',
                'copy'    => '即將上市的小雲機型預覽。正式規格、價格、政策與美國到貨資訊將於供應商確認後公布。',
                'points'  => [
                    'usa'     => '【待確認】美國庫存',
                    'fees'    => '【待確認】費用條款',
                    'support' => '【待確認】客服範圍',
            ...
            'bullets' => [
                'shipping' => '【到貨待確認】美國庫存與出貨',
                'warranty' => '【政策待確認】保固與退換貨',
                'fees'     => '【政策待確認】費用條款',
            ],
            'cta' => [
                'primary'   => '預覽 15P',
        ...
        'pricing' => [
            ...
            'cards'    => [
                '15p' => [
                    'badge'     => '即將上市',
                    'title'     => '小雲電視盒 15P',
                    'image_alt' => '小雲電視盒 15P 上市預覽',
                    'interval'  => '台',
                    'copy'      => '預覽即將上市的機型；規格、價格、庫存與政策仍待確認。',
                    'stock_note' => '庫存與出貨日期待確認',
                    'features'  => [
                        'newest'  => '【規格待確認】硬體與軟體',
                        'no_fees' => '【政策待確認】費用條款',
                        'support' => '【政策待確認】美國出貨、保固與客服',
                    ],
                    'cta'      => '探索 15P',
                    'buy_cta'  => '查看全新 15P',
                ],
    ...
    'shop' => [
        'hero' => [
            'badge'     => '選購',
            'title'     => '小雲電視盒',
            'subtitle'  => '美國授權經銷 — 搶先預覽即將上市的小雲 15P，或選購現有機型，享標準配送、一年保固與英文/中文客服。',
            'highlights' => [
        ...
        'cards' => [
            ...
            '15p' => [
                'title'   => '小雲電視盒 15P',
                'lead'    => '即將上市的機型預覽；規格、功能、費用與美國政策均待確認。',
                'button'  => '預覽 15P',
                'badge'   => '即將上市',
                'best_for' => '等待 15P 正式上市資料的買家',
                'price_label' => '上市價格',
                'price_tbc'   => '價格待確認',
                'price_note'  => '尚未公布正式價格',
                'image_alt'   => '小雲 15P 官方圖片待確認',
                'image_tbc'   => '官方圖片待確認',
                'features' => [
                    'hardware' => '【規格待確認】硬體與軟體配置',
                    'apps'     => '【功能待確認】應用、內容與費用條款',
                    'remote'   => '【規格待確認】遙控器與無線連線',
                ],
                'assurance' => [
                    'shipping' => '【政策待確認】庫存與出貨',
                    'warranty' => '【政策待確認】保固與退換貨',
                    'support'  => '【政策待確認】客服與安裝協助',
                ],
            ],
            '10p' => [
                'title'   => '小雲電視盒 10P+',
    ...
    'products' => [
        'svicloud-10p-plus' => [
            ...
            'crosslink' => [
                'badge'  => '新機登場',
                'title'  => '全新小雲 15P 即將上市',
                'lead'   => '想入手最新旗艦？先預覽 15P 上市頁；正式硬體規格與美國到貨資訊將於發布時確認。',
                'cta'    => '預覽小雲 15P',
                'target' => 'svicloud-15p',
            ],
        ],
        'svicloud-10s' => [
            ...
            'crosslink' => [
                'badge'  => '新機登場',
                'title'  => '搶先認識小雲 15P',
                'lead'   => '準備從入門款升級？先預覽 15P 上市頁，正式規格與美國到貨資訊將於發布時確認。',
                'cta'    => '預覽小雲 15P',
                'target' => 'svicloud-15p',
            ],
        ],
        'svicloud-9p' => [
            ...
            'description' => '<p>小雲 9P 是上一代機型。本頁持續保留，不刪除也不隱藏，供現有使用者查找與比較。</p><ul><li>9P 若仍符合需求，無需急著更換。</li><li>正式升級建議必須等待 15P 規格公布。</li><li>可先預覽 15P 上市頁，追蹤待確認項目。</li></ul>',
            'best_for' => [
                'badge' => '舊款機型',
                'title' => '正在評估下一台盒子的 9P 使用者',
                'copy'  => '如果 9P 仍正常使用，請繼續保留。等 15P 正式規格公布後，再依實際差異決定是否升級。',
                'bullets' => [
                    'primary'   => '保留舊款頁面與搜尋排名',
            ...
            'crosslink' => [
                'badge'  => '即將上市',
                'title'  => '考慮從 9P 升級？',
                'lead'   => '先預覽小雲 15P 上市頁。處理器、記憶體、無線規格、保固與美國到貨資訊均待發布確認。',
                'cta'    => '預覽小雲 15P',
                'target' => 'svicloud-15p',
            ],
        ],
        'svicloud-15p' => [
            'short_description' => '即將上市的小雲 15P 預覽頁。規格、價格、美國到貨、保固與盒內配件均待發布確認。',
            'description' => '<p>小雲 15P 是即將上市的機型。本預覽頁已先完成，但所有 15P 硬體與履約資訊都尚未定案。</p><ul><li>【規格待確認】處理器、記憶體、儲存、系統、影片解碼與無線連線。</li><li>【功能待確認】卡拉 OK、兒童模式、語音遙控、頻道內容與免月費條款。</li><li>【政策待確認】美國庫存、出貨時間、保固、退換貨與雙語客服範圍。</li><li>【盒內待確認】HDMI 線、電源、遙控器與其他配件。</li></ul><p>上市前將以供應商正式資料替換所有待確認項目。</p>',
            'prelaunch' => [
                'subtitle' => '上市預覽 — 規格、價格、庫存與政策尚未確認。',
                'detail'   => '暫不販售 · 等待供應商確認',
                'image_placeholder' => '小雲 15P 官方圖片待確認',
                'badges' => [
                    'specs'        => '規格待確認',
                    'availability' => '到貨待確認',
                    'policy'       => '政策待確認',
                ...
                'highlights' => [
                    'specs'        => '【規格待確認】硬體與功能',
                    'availability' => '【到貨待確認】美國庫存與出貨日期',
                    'policy'       => '【政策待確認】費用、保固、退換貨與客服',
                ],
                'reassurance' => [
                    'badge' => '下單前',
                    'title' => '請等待書面上市確認',
                    'copy'  => '本預覽頁不提供 15P 購買。下單前請確認正式產品與賣家條款。',
                    'bullets' => [
                        'shipping'  => '【政策待確認】庫存地點與出貨時間',
                        'warranty'  => '【政策待確認】保固與退換貨條款',
                        'concierge' => '【政策待確認】客服管道與安裝協助範圍',
                    ],
                ],
                'faq' => [
                    'specs' => [
                        'q' => '小雲 15P 規格已經確認了嗎？',
                        'a' => '尚未。處理器、記憶體、儲存、影片、Wi-Fi、系統、遙控器、應用與配件均待確認。',
                    ],
                    'availability' => [
                        'q' => '現在可以購買小雲 15P 嗎？',
                        'a' => '不可以。本頁是上市預覽；價格、美國庫存與出貨日期尚未確認。',
                    ],
                    'policy' => [
                        'q' => '15P 會提供哪些保固、退換貨與客服？',
                        'a' => '15P 專屬政策仍待確認，購買前必須取得書面條款。',
                    ],
                ],
            ],
            'best_for' => [
                'badge' => '最適合',
                'title' => '等待 15P 正式上市資料的買家',
                'copy'  => '本頁僅供追蹤新品。正式規格、價格與美國到貨確認前，不應把 15P 當作優於現有機型的選擇。',
                'bullets' => [
                    'primary'   => '【規格待確認】硬體與軟體配置',
                    'secondary' => '【適用待確認】效能驗證後再建議房間與用途',
                    'tertiary'  => '【政策待確認】費用、美國出貨、保固與客服條款',
                ],
            ],
            'traffic' => [
                'badge' => '15P 美國上市規劃',
                'title' => '預計提供美國履約與客服 — 尚待確認',
                'lead'  => '賣家計畫提供美國出貨與雙語客服，但所有 15P 專屬的庫存、運送、保固與到貨條款均須於上市時確認。',
                'bullets' => [
                    'shipping'  => '【政策待確認】美國庫存、出貨時間、追蹤與配件',
                    'concierge' => '【政策待確認】中英雙語安裝與客服範圍',
                    'warranty'  => '【政策待確認】保固期限與退換貨期間',
                ],
            ],
            'comparison' => [
                'badge' => '機型比較',
                'title' => '小雲 15P vs 10P+ vs 9P — 上市確認清單',
                'lead'  => '15P 正式規格尚未公布。以下比較只列出上市前必須驗證的項目，不宣稱尚未證實的升級優勢。',
                'cards' => [
                    'vs_10p' => [
                        'title'   => '15P vs 10P+',
                        'summary' => '10P+ 已有公開規格；目前沒有任何 15P 硬體優勢獲得證實。',
                        'bullets' => [
                            'one'   => '【規格待確認】比較處理器、記憶體與 10P+（4GB/64GB）的差異',
                            'two'   => '【規格待確認】比較無線連線與 10P+ Wi-Fi 6 的差異',
                            'three' => '【功能待確認】驗證卡拉 OK、兒童模式、語音遙控與費用條款是否延續',
                        ],
                        'link_label' => '查看小雲 10P+',
                    ],
                    'vs_9p' => [
                        'title'   => '15P vs 9P',
                        'summary' => '正式規格與實機測試公布前，不能宣稱 15P 效能優於 9P。',
                        'bullets' => [
                            'one'   => '【規格待確認】比較處理器、記憶體、儲存與 Android 版本',
                            'two'   => '【規格待確認】驗證 AV1、Wi-Fi 世代與影片輸出',
                            'three' => '【測試待確認】測量開機、App 切換、串流穩定與支援政策',
                        ],
                ...
                'upgrade' => [
                    'title' => '誰適合升級',
                    'items' => [
                        'from_9p'   => '從 9P 或更舊機型：等待正式規格與實機測試後再決定。',
                        'from_10p'  => '從 10P/10P+：除非經驗證的 15P 差異能解決特定需求，否則繼續使用現有機型。',
                        'new_buyer' => '第一次購買：上市時比較正式價格、功能、庫存與政策條款。',
                    ],
                ],
                'assurance' => [
                    'title' => '預計提供美國履約與客服 — 條款待確認',
                    'items' => [
                        'shipping' => '【政策待確認】庫存地點、處理時間、追蹤與配送範圍',
                        'support'  => '【政策待確認】中英雙語客服管道與服務範圍',
                        'warranty' => '【政策待確認】保固期限、退換貨與美國處理方式',
                    ],
                ],
            ],
        ],
    ...
    'guides' => [
        ...
        'troubleshooting' => [
            'badge' => '疑難排解',
            'title' => '常見問題快速解法',
            'lead'  => '聯繫禮賓服務前，請先試試以下步驟，能解決絕大多數安裝與串流問題。',
            'items' => [
                'remote' => [
                    'title' => '遙控器無法配對',
                    'copy'  => '取出電池，等待 10 秒後重新裝回，靠近機身 1 公尺內，同時按住 <kbd>VOL-</kbd> + <kbd>VOL+</kbd> 3 秒，直到 LED 閃爍並看到配對成功提示。若仍失敗，請更換新的 AAA 電池。',
                ],
                'streaming' => [
                    'title' => '畫面模糊或不斷緩衝',
                    'copy'  => '建議改用網路線連接以獲得最穩定的速度。若使用 Wi-Fi，請連接 5 GHz 頻段，並將機器移至靠近路由器的位置，避免放在電視後方。持續緩衝時請重啟路由器。建議頻寬至少 15 Mbps 以確保 4K 流暢播放。',
                ],
                'no_signal' => [
                    'title' => '電視顯示「無訊號」',
                    'copy'  => '確認電視已切換至正確的 HDMI 輸入孔。從兩端拔除 HDMI 線，等待 10 秒後重新插緊。也可嘗試電視上的其他 HDMI 插孔。若使用 AV 擴大機或 Soundbar 中繼，請先直接連接電視，排除設備問題。',
                ],
                'wifi_disconnect' => [
                    'title' => 'Wi-Fi 持續斷線',
                    'copy'  => '前往 <strong>設定 &gt; 網路</strong>，先忘記目前的 Wi-Fi，再重新連線。建議選擇 5 GHz 頻段以減少干擾。若路由器支援 Wi-Fi 6，請確認已啟用。避免將機器放在微波爐、嬰兒監控器或其他 2.4 GHz 設備附近。建議最終改用 Ethernet 有線連接。',
                ],
                'audio_sync' => [
                    'title' => '音效不同步或無聲',
                    'copy'  => '前往 <strong>設定 &gt; 顯示與音效</strong>，若使用電視喇叭請選擇 PCM；若使用 Soundbar 或 AV 擴大機則選 Auto 或 Passthrough。可嘗試關閉再開啟 HDMI CEC。若音效有延遲，請更換 HDMI 線或插孔。重啟機器通常可解決暫時性的同步問題。',
                ],
                'frozen' => [
                    'title' => '機器當機或無回應',
                ...
                'voice_remote' => [
                    'title' => '語音搜尋無法使用',
                    'copy'  => '請確認遙控器已透過藍牙配對（而非僅使用紅外線）。按住麥克風鍵並在手臂可及的距離內清楚說話。若無反應，請至 <strong>設定 &gt; 遙控器與配件</strong> 重新配對。語音搜尋需要網路連線，韌體更新期間可能暫時無法使用。',
                ],
                'hdmi_resolution' => [
                    'title' => '畫面比例錯誤或被裁切',
                    'copy'  => '前往 <strong>設定 &gt; 顯示與音效 &gt; 解析度</strong>，選擇「自動」或符合電視原生解析度（通常為 4K/2160p）。若畫面過度放大，請在電視端將畫面比例設為「點對點」、「1:1」或「Just Scan」（依電視品牌不同）。請關閉電視的任何縮放模式。',
                ],
                'orz' => [
                    'title' => '串流 App 無法開啟',
                    'copy'  => '確認該 App 來自合法授權平台。前往 <strong>設定 &gt; 應用程式</strong> 清除快取後重新開啟。若 App 持續閃退，請移除後重新安裝。第三方或未授權 App 的問題超出我們的支援範圍，請直接聯繫該 App 的客服。',
                ],
            ],
        ],
        'resources' => [
