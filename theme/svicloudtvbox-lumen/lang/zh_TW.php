...
return [
    ...
    'icons' => [
        'truck'     => '小雲電視盒 美國代理 配送時程依承運商為準圖示',
        'tool'      => '小雲盒子10P+ 禮賓安裝工具圖示',
        'lock'      => '原廠保固鎖定圖示',
        'star'      => '授權經銷星徽圖示',
        'box'       => '小雲盒子10P+ 產品圖示',
        'bolt'      => 'Wi-Fi 6 高速性能閃電圖示',
        'handshake' => '中英雙語禮賓握手圖示',
        'satellite' => '衛星啟用支援圖示',
        'wifi'      => 'Wi-Fi 網路優化圖示',
        'mic'       => '卡拉 OK 麥克風圖示',
        'family'    => '家庭禮賓服務圖示',
    ...
    'support' => [
        ...
        'help' => [
            'contact' => [
                'title' => '想立即與真人聯絡？',
                'copy'  => '透過電話、簡訊或 Email 與我們的雙語客服即時聯繫。',
                'cta'   => '前往聯絡客服頁面',
            ],
            'install' => [
                'title' => 'App 安裝教學',
                'copy'  => '退貨前，可先依步驟完成 App 安裝或更新。',
                'cta'   => '開啟 App 教學',
            ],
            'faq' => [
                'title' => '先查看常見問題',
    ...
    'return_policy' => [
        'hero' => [
            'badge'    => '退換貨服務',
            'title'    => '退換貨與退款政策',
            'subtitle' => '我們希望您喜愛小雲電視盒。如需退換貨，請在交貨後 14 天內依照以下步驟申請。',
        ],
        'timeline' => [
            'title' => '退貨流程時間表',
            'items' => [
                'request'  => '請在交貨日起 14 天內提出退貨申請。',
                'approval' => '我們會確認申請資格並提供配送時程與承運商資訊。',
                'ship'     => '核准後請在 7 天內寄回商品。',
        ...
        'sections' => [
            'damage' => [
                'title' => '硬體保固與人為損壞',
                'items' => [
                    'coverage' => '我們的一年美國硬體保固涵蓋正常使用下的製造瑕疵。在法律允許的範圍內，不涵蓋因誤用、意外、液體侵入、不當連接、過度施力或未經授權的維修或改裝所造成的損壞。不得僅因裝置曾被改裝，就排除與改裝無關的瑕疵。',
                    'examples' => '例如：強行插入接頭、以錯誤方向插入，或未取下接頭保護套便插入，導致連接埠、接頭外殼、接腳或內部防塵蓋損壞。但零件鬆脫或破損本身，並不足以判定為人為損壞。',
                    'eligibility' => '人為造成的損壞不適用免費保固維修、更換，或一般改變心意退貨政策下的退款。製造瑕疵與由本店造成的損壞另行評估；適用的法定消費者權益不受影響。',
                    'assessment' => '我們會審閱問題描述、照片、製造商意見，並在必要時進行實物檢查後判定保固範圍。我們會說明判定依據及可提供的處理方式。收到寄回說明前，請勿自行寄回裝置。',
                    'costs' => '若可提供付費維修或其他付費服務，我們會事先說明費用、任何檢查費及運費責任，經您同意後才進行。非瑕疵退貨最高 10% 的整新費並非損壞鑑定費。',
                    'existing' => '既有訂單仍依購買時提供的條款及適用法律處理。本次更新不追溯變更既有訂單的條款。',
                ],
            ],
            'eligibility' => [
                'title' => '申請前請先確認資格',
                'items' => [
                    'window'    => '退貨申請需在交貨日起 14 天內提出。',
            ...
            'shipping' => [
                'title' => '運費與整新費用',
                'items' => [
                    'responsibility' => '退貨運費一律由客戶自行負擔。',
                    'restock'        => '已開封或已使用且非瑕疵商品的退貨，以及缺少配件的退貨，可能需支付最高商品價格 10% 的整新費。',
    ...
    'shipping_policy' => [
        'hero' => [
            'badge'    => '運送資訊',
            'title'    => '運送政策',
            'subtitle' => '從內華達州倉庫快速可靠地送達您家門口。美國境內全面免運費。',
        ],
        'sections' => [
            'processing' => [
                'title' => '訂單處理',
                'items' => [
                    'cutoff'   => '週一至週五太平洋時間下午 2:00 前下單，當日即可處理出貨。',
                    'dispatch' => '大多數訂單在付款確認後 24-48 小時內出貨。',
                    'tracking' => '出貨後您將收到包含追蹤號碼的確認郵件。',
                ],
            ],
            'domestic' => [
                'title' => '美國境內運送',
                'items' => [
                    'standard' => '標準運送依地區不同，通常 2-5 個工作天送達。',
                    'carriers' => '依包裹大小與目的地，我們使用 USPS、UPS 或 FedEx 配送。',
                    'free'     => '美國境內所有訂單皆享免運費，無最低消費限制。',
                ],
            ],
            'canada' => [
                'title' => '加拿大運送',
                'items' => [
                    'timeframe' => '加拿大訂單通常 5-7 個工作天送達，含海關處理時間。',
                    'customs'   => '包裹會附上正確的海關申報以順利通關。',
                    'duties'    => '進口關稅、稅金與海關費用由收件人負擔，不含在商品價格內。',
                ],
            ],
            'issues' => [
                'title' => '運送問題',
                'items' => [
                    'delays'  => '旺季或惡劣天氣可能造成運送延遲。請追蹤包裹以取得最新狀態。',
                    'damaged' => '若包裹送達時有損壞，請在 48 小時內聯繫客服並附上損壞照片。',
                    'lost'    => '若包裹顯示「已送達」但未收到，請在 7 天內聯繫我們。我們會與承運商協調處理。',
                ],
            ],
        ],
        'support' => [
            'title' => '對運送有疑問？',
            'copy'  => '雙語客服團隊隨時為您追蹤訂單或解決任何運送問題。',
            'cta'   => '聯絡客服',
        ],
    ],
    ...
    'privacy_policy' => [
        ...
        'sections' => [
            'collect' => [
                'title' => '我們收集的資訊',
                'items' => [
                    'personal' => '<strong>個人資訊：</strong>您下單或聯繫我們時提供的姓名、電子郵件、電話號碼與送貨地址。',
                    'payment'  => '<strong>付款資訊：</strong>信用卡資料透過我們的支付服務商安全處理，不會儲存在我們的伺服器上。',
                    'device'   => '<strong>裝置資訊：</strong>您瀏覽本網站時的瀏覽器類型、IP 位址與裝置識別碼。',
                    'usage'    => '<strong>使用資料：</strong>瀏覽頁面、停留時間與互動資訊，用以改善您的體驗。',
                ],
            ],
            'use' => [
                'title' => '我們如何使用您的資訊',
                'items' => [
                    'orders'      => '處理並完成您的訂單，包括運送與到貨通知。',
                    'support'     => '提供客戶支援並回覆您的詢問。',
                    'improve'     => '根據您的回饋與使用模式改善我們的網站、產品與服務。',
                    'communicate' => '發送訂單確認、運送更新，以及偶爾的促銷優惠（您可隨時取消訂閱）。',
                ],
            ],
            'sharing' => [
                'title' => '資訊分享',
                'items' => [
                    'processors' => '<strong>支付處理商：</strong>我們與符合 PCI 規範的安全支付處理商分享付款資訊以完成交易。',
                    'shipping'   => '<strong>物流承運商：</strong>我們與承運商（USPS、UPS、FedEx）分享您的姓名與地址以配送訂單。',
                    'legal'      => '<strong>法律要求：</strong>當法律要求或為保護我們的權益與安全時，我們可能揭露資訊。',
                    'nosell'     => '<strong>我們不會出售您的個人資訊</strong>給第三方作為行銷用途。',
                ],
            ],
            'cookies' => [
                'title' => 'Cookie 與追蹤',
                'items' => [
                    'essential' => '<strong>必要 Cookie：</strong>網站功能、購物車與結帳流程所必需。',
                    'analytics' => '<strong>分析 Cookie：</strong>幫助我們了解訪客如何使用網站以改善效能。',
                    'control'   => '您可透過瀏覽器設定控制 Cookie。停用 Cookie 可能影響網站功能。',
                ],
            ],
            'security' => [
                'title' => '資料安全',
                'items' => [
                    'ssl'    => '所有傳輸至本網站的資料均使用 SSL/TLS 技術加密。',
                    'pci'    => '付款處理由符合 PCI-DSS 規範的服務商處理。',
                    'access' => '個人資訊的存取僅限於授權人員。',
                ],
            ],
            'rights' => [
                'title' => '您的權利',
                'items' => [
                    'access'  => '<strong>存取：</strong>要求取得我們持有的您的個人資訊副本。',
                    'correct' => '<strong>更正：</strong>要求更正不正確或不完整的資訊。',
                    'delete'  => '<strong>刪除：</strong>要求刪除您的個人資訊，但須遵守法定保留要求。',
                    'optout'  => '<strong>退出：</strong>隨時使用郵件中的連結取消訂閱行銷郵件。',
                ],
            ],
        ],
        'support' => [
            'title' => '有隱私相關問題？',
            'copy'  => '如對本政策有疑問或希望行使您的隱私權，請聯繫我們的團隊。',
            'cta'   => '聯絡我們',
        ],
    ],
    ...
    'cart_page' => [
        ...
        'summary'           => [
            'title' => '訂單摘要',
            'intro'        => '美國內華達州倉庫標準配送，提供雙語禮賓服務。',
            'empty'        => '加入商品後，這裡會顯示配送方式、保固與結帳金額。',
            'reassurance'  => '支援 PayPal、Visa、Mastercard 與 American Express 安全結帳。',
        ],
        'benefits'          => [
            'shipping' => [
                'title' => '標準配送',
                'copy'  => '每個工作天由內華達州倉庫寄出，配送時程依承運商為準。',
            ],
            'warranty' => [
                'title' => '美國保固',
    ...
    'checkout_page' => [
        'badge'    => '安全結帳',
        'title'    => '完成您的小雲電視盒訂單',
        'subtitle' => '內華達州倉庫 配送時程依承運商為準，附英文與中文禮賓服務。',
        'summary'  => [
            'title'         => '訂單摘要',
    ...
    'order_tracking' => [
        ...
        'summary' => [
            ...
            'details_note'    => '以下列出配送商品、金額與帳單資訊供您確認。',
    ...
    'order_thankyou' => [
        ...
        'summary' => [
            ...
            'tracking_note'   => '商品配送後，我們會立即寄送物流追蹤資訊。',
            'details_heading' => '訂單明細',
            'details_note'    => '以下列出配送商品、金額與帳單資訊供您確認。',
        ],
        'cta' => [
        ...
        'review' => [
            'badge' => 'Google 評價邀請',
            'copy'  => '若您的訂單符合 Google Customer Reviews 條件，商品送達後 Google 可能會寄出一份簡短問卷。這些真實評價有助於強化我們在 Google 上的商家信任度。',
        ],
        'next' => [
            'badge' => '下單後建議',
            'title' => '先收藏安裝指南，也把支援與比較頁留好',
            'copy'  => '多數客人在下單後會先做三件事：收藏安裝指南、把比較頁分享給家人，以及保留禮賓客服連結。',
            'cards' => [
                'setup' => [
                    'title' => '先打開安裝指南',
                    'copy'  => '現在先收藏中英雙語快速安裝教學，收到機器後會更容易上手。',
                    'cta'   => '查看安裝指南',
                ],
                'share' => [
                    'title' => '之後可能還需要第二台？',
                    'copy'  => '把比較頁分享給家人，之後要在 10P+ 與 10S 間做選擇會更輕鬆。',
                    'cta'   => '打開比較頁',
                ],
                'support' => [
                    'title' => '保留禮賓客服連結',
    ...
    'footer' => [
        'tagline'   => '美國授權經銷 · 雙語客服與本地保固',
        'summary'   => '提供中英雙語客服與一年原廠保固，暢看中美熱門節目。',
        'badges'    => [
            'ships'     => '美國本地支援',
            'warranty'  => '一年美國保固',
            'concierge' => '英文與中文客服支援',
        ...
        'benefits'  => [
            'shipping'  => [
                'label'       => '標準配送與追蹤',
                'description' => '提供標準配送並附追蹤碼，實際時程依承運商為準。',
            ],
            'dealer'    => [
                'label'       => '官方授權經銷商',
    ...
    'frontpage' => [
        ...
        'traffic' => [
            'badge' => '2026 美國華人/亞洲家庭的 10P+',
            'title' => '免去水貨煩惱。中文或英文禮賓代客設定，內華達 48 小時出貨。',
            'lead'  => '專為 2026 在美華人/亞洲家庭：內華達倉 48 小時出貨，中文/English 禮賓代客設定，硬體能跑 4K 體育、追劇、卡拉 OK 與兒童模式。',
            'bullets' => [
                'shipping'  => '48 小時美國出貨，附在地電源/HDMI 與追蹤編號',
                'concierge' => '雙語禮賓：遠端設定、Wi-Fi 調校、卡拉 OK 麥克風配對、Kids Mode 指南',
                'warranty'  => '1 年美國保固 + 14 天退換貨，禮賓全程協助',
            ],
            'links' => [
                'pdp'     => '選購 10P+',
                'compare' => '比較 10P+ 與 10S',
                'faq'     => '查看常見問題',
                'contact' => '聯絡禮賓客服',
                'guide_2026' => '閱讀 2026 購買指南',
            ],
        ],
        'certification' => [
            'badge' => '原廠授權',
        ...
        'feature_grid' => [
            ...
            'subtitle' => '專為 2026 家庭串流需求打造：超高清 4K 體育、追劇馬拉松與卡拉 OK 夜晚都穩定順暢。',
            'cards'    => [
                'entertainment' => [
                    'title' => '全方位娛樂',
                ...
                'orders' => [
                    ...
                    'items' => [
                        'fulfillment' => [
                            ...
                            'answer'   => '美西時間下午 2 點前成立的訂單，配送時程依承運商為準由內華達州倉庫以 USPS、UPS 或 FedEx 配送，寄出後會自動寄送追蹤碼。寄往加拿大通常 5–7 個工作天（含清關時間）。',
                        ],
                        'warranty' => [
                            'question' => '有美國保固與退換貨服務嗎？',
                            'answer'   => '在 SVICLOUDTVBOX.US 購買的裝置皆享一年美國原廠保固與 14 天內退換貨。提供訂單編號給禮賓客服，我們會先協助檢測並安排換貨或退款流程。',
                        ],
                        'payment' => [
                            'question' => '支援哪些付款方式？',
        ...
        'pricing' => [
            ...
            'cards'    => [
                '15p' => [
                    'badge'     => '現貨供應',
                    'title'     => '小雲 15P 電視盒',
                    'image_alt' => '小雲 15P Android 14 訂購圖',
                    'interval'  => '台',
        ...
        'aria' => [
            'hero_visual'    => '小雲電視盒語音助理介面，含 Google Play、電影與 YouTube 應用',
            'traffic_actions'=> '小雲電視盒主要操作',
            'shop_now'       => '立即選購',
            'metrics'        => '小雲電視盒重點優勢',
        ],
        'schema' => [
            'item_list_name' => '北美可購買的小雲電視盒設備',
        ],
        'confidence' => [
            'badge' => '安心下單',
            'title' => '為什麼直接在 SVICLOUDTVBOX.US 下單',
            'subtitle' => '不靠假星等與模糊評價，只提供官方美國現貨、雙語協助，以及清楚的售後流程。',
            'cards' => [
                'official' => [
                    'title' => '美國官方授權通路',
                    'copy'  => '原廠授權的美國銷售網站，販售正版 SVICLOUD 硬體並提供保固支援。',
                ],
                'shipping' => [
                    'title' => '內華達在地出貨',
                    'copy'  => '美國現貨出貨附追蹤碼，盒內也備妥本地使用的電源與 HDMI 配件。',
                ],
                'concierge' => [
                    'title' => '中英雙語禮賓',
                    'copy'  => '可協助首次安裝、Wi-Fi 調校，以及開箱後的基本設定問題。',
                ],
                'warranty' => [
                    'title' => '保固與退換貨清楚',
                    'copy'  => '每台裝置皆含 1 年美國硬體保固與 14 天退換貨期間。',
                ],
            ],
            'timeline' => [
                'badge' => '下單之後',
                'aria_label' => '下單之後會發生什麼',
                'title' => '接下來會發生什麼',
                'lead'  => '流程很單純：安全結帳、內華達出貨、Email 追蹤，以及需要時可聯絡禮賓。',
                'steps' => [
                    'order' => [
                        'title' => '安全完成訂單',
                        'copy'  => '透過安全結帳頁使用主流信用卡、PayPal 與可用的快速付款方式完成付款。',
                    ],
                    'dispatch' => [
                        'title' => '由內華達州出貨',
                        'copy'  => '美國現貨在地包裝，通常 48 小時內寄出，並透過 Email 提供追蹤資訊。',
                    ],
                    'setup' => [
                        'title' => '開箱後可取得安裝協助',
                        'copy'  => '您可以先依照快速入門指南安裝，也可請禮賓用中文或英文協助設定。',
                    ],
                    'support' => [
                        'title' => '後續支援仍找得到人',
                        'copy'  => '若後續遇到硬體問題，保固與退換貨流程都維持清楚且在美國處理。',
                    ],
                ],
            ],
        ],
        'testimonials' => [
            ...
            // 以下佔位文字（FTC 規定不可造假，可使用 email、FB 或 Google
            // 評論的真實留言）。
            'quotes' => [
                [
    ...
    'shop' => [
        ...
        'cards' => [
            ...
            '15p' => [
                ...
                'price_tbc'   => '現貨供應',
                'price_note'  => '現貨供應',
                'delivery_banner_label' => '訂購配送',
                'delivery_banner_copy'  => '現貨供應。',
                'image_alt'   => '小雲 15P Android 14 訂購圖',
    ...
    'products' => [
        'svicloud-10p-plus' => [
            ...
            'best_for' => [
                ...
                'copy'  => '如果你想要最完整的客廳配置、旗艦效能，以及從第一天就能用上的家庭娛樂功能，10P+ 會是更穩妥的選擇。',
                'bullets' => [
                    'primary'   => '4GB 記憶體 / 64GB 儲存，較適合多 App、多工與更高效能需求',
                    'secondary' => '內建兒童模式、卡拉 OK 應用與語音遙控支援',
        ...
        'svicloud-10s' => [
            ...
            'best_for' => [
                ...
                'copy'  => '如果你想用更合理的預算獲得穩定的 4K SVICLOUD 體驗、美國現貨，以及雙語支援，10S 就很值得直接入手。',
                'bullets' => [
                    'primary'   => '以較低門檻進入 SVICLOUD 系列，同時保留核心 4K 播放與 AV1 解碼',
                    'secondary' => '很適合次要房間、客房、租屋處與較簡單的日常使用情境',
                    'tertiary'  => '只有在你需要卡拉 OK、兒童模式或系列中最高效能時，才需要升級到 10P+',
                ],
            ],
            'traffic' => [
                'badge' => '為在美華人/亞洲家庭打造的 10S',
                'title' => '適合臥室、客房與第二台電視的高性價比 SVICLOUD',
                'lead'  => '10S 適合想用較低預算取得穩定 SVICLOUD 影音體驗、同時享有美國現貨與雙語客服的買家。',
                'bullets' => [
                    'shipping'  => '48 小時美國出貨，附在地電源/HDMI 配件與追蹤編號',
                    'concierge' => '雙語禮賓協助安裝、Wi‑Fi 調校與應用程式開箱教學',
    ...
    'compare' => [
        ...
        'confidence' => [
            ...
            'cards' => [
                'official' => [
                    'title' => '美國官方銷售通路',
                    'copy'  => '向原廠授權的美國經銷商購買正版 SVICLOUD 裝置。',
                ],
                'shipping' => [
                    'title' => '內華達州追蹤出貨',
                    'copy'  => '從美國現貨寄出，附追蹤資訊與適合本地使用的完整配件。',
                ],
                'concierge' => [
                    'title' => '雙語安裝協助',
                    'copy'  => '提供 English / 中文 開箱協助、Wi-Fi 調校與遙控器配對說明。',
                ],
                'warranty' => [
                    'title' => '購買後仍有保固',
                    'copy'  => '退貨資格請見本店公開政策；特定機型的保固範圍請向客服確認。',
                ],
            ],
            'timeline' => [
                'badge' => '訂單流程',
                'title' => '從選機到家中安裝',
                'lead'  => '比較頁的目的，是讓下一步更明確，而不是讓你承擔更多風險。',
                'steps' => [
                    'choose' => [
                        'title' => '先選適合房間與預算的機型',
                        'copy'  => '用比較表與「最適合」說明，先判斷哪一台最符合你的使用情境。',
                    ],
                    'order' => [
                        'title' => '從美國官方網站下單',
                        'copy'  => '直接在官方美國站結帳，比起灰市賣場更容易取得保固與售後協助。',
                    ],
                    'dispatch' => [
                        'title' => '收到追蹤與出貨通知',
                        'copy'  => '內華達州在地配貨讓物流更清楚，若有問題也更容易追蹤與處理。',
                    ],
                    'setup' => [
                        'title' => '需要時可找禮賓協助安裝',
                        'copy'  => '第一次安裝、Wi-Fi 設定或基本功能上手，都可以聯絡禮賓客服協助。',
                    ],
                ],
            ],
        ],
    ...
    'about' => [
        ...
        'story' => [
            ...
            'warehouse_alt'     => '小雲電視盒內華達州倉庫，展示庫存與出貨作業',
            'warehouse_caption' => '我們的內華達州倉庫：本地庫存，美國配送更迅速',
        ],
        'stats' => [
            'orders' => [
                'value' => '6,500+',
        ...
        'certification' => [
            ...
            'points' => [
                ...
                'inventory' => '維持美國倉庫現貨，配送時程依承運商為準完成配送與換貨。',
        ...
        'timeline' => [
            ...
            'items' => [
                ...
                '2022' => [
                    'year'  => '2022',
                    'title' => '建立美國物流中心',
                    'copy'  => '內華達州倉庫正式運作，大幅縮短配送與保固處理時間。',
                ],
                '2024' => [
                    'year'  => '2024',
                    'title' => '擴大全美社群',
                    'copy'  => '全美範圍配送，並舉辦卡拉 OK、體育賽事與節慶直播活動。',
                ],
                '2025' => [
                    'year'  => '2025',
                    'title' => '取得原廠授權',
        ...
        'location' => [
            'badge'    => '美國地址',
            'title'    => '內華達州倉儲與客服中心',
            'lead'     => '所有小雲電視盒訂單均由北拉斯維加斯倉庫出貨。退貨、保固處理與客服作業皆在同一地點完成，無需跨國轉送。',
    ...
    'guides' => [
        ...
        'nav_summaries' => [
            ...
            'apps'            => '學會從可信來源安裝 App，並完成首次開啟。',
            'yogurt_mo'       => '在 Android 設備安裝 15P Yogurt Mo，並設定同一網路最多兩台設備使用。',
        ...
        'apps' => [
            'badge' => 'App 安裝',
            'title' => '如何在小雲電視盒安裝 App',
            'lead'  => '請依照以下步驟在小雲電視盒安裝或重新安裝 Yogurt TV。若從其他來源安裝名稱相似的 App，可能會要求 VIP 會員，也可能不是正確版本。',
            'items' => [
                'internet' => [
                    'title' => '1. 確認電視盒已連上網路',
                    'copy'  => '打開「設定 → 網路」，確認 Wi-Fi 或 Ethernet 顯示已連線。若網路不穩，請先重啟路由器或改用網路線，再安裝 Yogurt TV。',
                ],
                'installer' => [
                    'title' => '2. 開啟 Orz Browser',
                    'copy'  => '從主畫面開啟 Orz Browser。如果沒有馬上看到，請到 Apps 或所有應用程式清單中尋找。',
                ],
                'search' => [
                    'title' => '3. 輸入安裝網址',
                    'copy'  => '在 Orz Browser 的網址列輸入 8989c.cc 並開啟頁面。請完全照著輸入。',
                ],
                'install' => [
                    'title' => '4. 找到並安裝 Yogurt TV',
                    'copy'  => '在 App 頁面找到 Yogurt TV，然後下載並安裝。請不要從其他 App Store 隨便安裝名稱相似的 App。',
                ],
                'open' => [
                    'title' => '5. 如有權限提示請允許',
                    'copy'  => '如果 Android 詢問是否允許從此來源安裝，請選擇允許並繼續。請等待安裝完整完成後再拔電源。',
                ],
                'support' => [
                    'title' => '6. 開啟 Yogurt TV 並測試',
                    'copy'  => '安裝完成後開啟 Yogurt TV。如果仍要求 VIP 會員、無法開啟或出現錯誤，請傳清楚的電視畫面照片與訂單編號給我們，以便確認是否安裝到正確 App。',
                ],
            ],
        ],
        'yogurt_mo' => [
            'badge' => '15P App 設定',
            'title' => '如何在 Android 設備安裝 15P Yogurt Mo',
            'lead'  => 'Yogurt Mo 是 15P 較新的 Android App 選項。公開的 15P 官方文件有限，因此本頁以實用安裝流程為主；若你的啟動畫面不同，請聯絡客服確認。',
            'items' => [
                'compatibility' => [
                    'title' => '使用 Android 設備',
                    'copy'  => 'Yogurt Mo 可安裝在 Android 手機、Android 平板、Android TV 或安卓電視盒。iPhone、iPad、Roku、Fire TV 與非 Android 智慧電視系統不一定適用同一套 APK 安裝方式。',
                ],
                'download' => [
                    'title' => '從 Yogurt TV 選擇 Bind 並掃描 QR code',
                    'copy'  => '在 SVICLOUD 15P 上打開 Yogurt TV，找到 Bind 綁定選項，使用要安裝 Yogurt Mo 的 Android 手機或平板掃描畫面上的 QR code。依照 15P 來源頁面下載或啟用 Yogurt Mo。避免從隨機 APK 網站下載名稱相似的 App，以免裝到錯誤版本或被要求不相關的 VIP 會員。',
                ],
                'permission' => [
                    'title' => '允許 APK 安裝',
                    'copy'  => '如果 Android 阻擋安裝，請到設定中允許目前使用的瀏覽器或檔案管理器「安裝未知 App」。Yogurt Mo 安裝完成後，可再把該權限關閉。',
                ],
                'install' => [
                    'title' => '開啟 APK 並完成安裝',
                    'copy'  => '打開下載好的 APK，選擇 Install / 安裝，等待確認畫面出現。安裝期間請保持 Wi-Fi 連線，不要強制關閉安裝程式。',
                ],
                'same_network' => [
                    'title' => '同一網路最多設定兩台設備',
                    'copy'  => '若使用 15P 的兩台設備方案，請讓兩台 Android 設備連到同一台家用路由器或同一個 Wi-Fi。設定時先關閉 VPN，App 如要求登入或授權，請使用同一組 15P 授權資訊。',
                ],
                'verify' => [
                    'title' => '分別測試兩台設備播放',
                    'copy'  => '先在第一台設備開啟 Yogurt Mo 並確認可播放，再保持同一網路，在第二台設備開啟測試。若第二台失敗，請先重啟兩台設備與路由器，再請客服協助重置設備綁定。',
                ],
                'support' => [
                    'title' => '將錯誤畫面傳給客服',
                    'copy'  => '若啟用、登入或播放失敗，請提供訂單編號、設備型號、Android 版本、網路設定，以及清楚的 Yogurt Mo 錯誤畫面照片。',
                ],
            ],
            'note_title' => '發布前的重要提醒',
            'note_copy'  => '目前公開的 15P 專屬文件有限。若你的畫面出現不同的啟用或登入流程，請先把畫面拍照傳給客服，不要急著重置 App。',
        ],
        'post_setup' => [
            'badge' => '安裝完成後',
            'title' => '上線後別錯過這些設定',
        ...
        'troubleshooting' => [
            'badge' => '',
            'title' => 'SVICLOUD 15P 疑難排解',
            'lead' => '先選擇您的 15P 症狀。每次只做一項檢查，再測試是否恢復。請勿一開始就恢復出廠設定。',
            'intro_title' => '從這裡開始：選擇症狀',
            ...
            'items' => [
                'remote' => [
                    'title' => '遙控器按鍵或語音無反應',
                    'copy' => '<ol><li>檢查電池方向並嘗試新電池。將遙控器朝向盒子，移開遮擋物。</li><li>紅外線電源鍵可用，不代表藍牙已配對。若方向鍵或語音失效，請依 15P 隨附說明檢查連線，不要猜測配對按鍵組合。</li><li>若反覆斷開配對，或換過遙控器仍有相同問題，請停止反覆重設，提供型號及短片給客服。</li></ol>',
                ],
                'streaming' => [
                    'title' => '播放緩衝或畫質下降',
                    'copy' => '<ol><li>比較其他頻道或影片，再試另一個 App。只有一個來源出問題，可能與該來源有關，但不能證明盒子或網路完全正常。</li><li>可用時改用有線網路，或把盒子移近路由器。暫停其他大量下載後再測試。</li><li>連線穩定度、服務與影片畫質都會影響播放；單一網速不能保證流暢 4K。仍有問題時，請提供 App、頻道或片名及發生時間。</li></ol>',
                ],
                'no_signal' => [
                    'title' => '電視顯示無訊號或黑畫面',
                    'copy' => '<ol><li>確認盒子已供電，且電視切到對應的 HDMI 輸入。</li><li>關閉設備電源後重新接好 HDMI 線。嘗試另一條已知正常的線或電視 HDMI 插孔。</li><li>若經過擴大機或聲霸，先將盒子直接接電視測試。仍無畫面時，請先聯絡客服，不要自行進入復原或重設。</li></ol>',
                ],
                'wifi_disconnect' => [
                    'title' => 'Wi-Fi 斷線或已連線但無網際網路',
                    'copy' => '<ol><li>檢查同一網路的其他設備能否上網。若也失敗，可重新啟動路由器。</li><li>先確認 Wi-Fi 密碼，再忘記網路並重新連線。靠近路由器測試，或改用有線網路。</li><li>若行動數據額度允許，可短暫比較手機熱點。結果不同表示與網路環境有關，不能直接認定是業者封鎖或 DNS 故障。請勿盲目修改固定 IP。</li></ol>',
                ],
                'audio_sync' => [
                    'title' => '沒有聲音或聲畫不同步',
                    'copy' => '<ol><li>檢查靜音、電視或聲霸輸入，並以舒適音量測試其他 App 或影片。</li><li>先以 HDMI 直接連電視，排除聲霸或擴大機影響。若有音訊格式選項，可記下原設定，再試 PCM 相容性測試。</li><li>若有延遲，檢查電視或聲霸的聲畫同步設定。仍有問題時，提供連接方式及 App 名稱給客服。</li></ol>',
                ],
                'app_cache' => [
                    'title' => 'App 閃退：清除快取還是資料？',
                    'copy' => '<ol><li>關閉並重新開啟該 App。盒子仍可操作時，可正常重新啟動。</li><li>在 App 設定中，若有清除快取選項，可先清除再測試。快取是暫存檔；清除資料或儲存空間可能移除登入與 App 設定。</li><li>尚未確認如何恢復 App 與帳號前，不要清除資料、解除安裝或恢復出廠設定。持續閃退時，請提供 App 版本與錯誤訊息。</li></ol>',
                ],
                'stuck_loading' => [
                    'title' => '當機、停在標誌或進入 Recovery',
                    'copy' => '<ol><li>若正在更新，請勿中斷電源。否則先關機，拔電 2–3 分鐘並移除外接 USB 配件，再接回原廠電源供應器及 HDMI。</li><li>保持通風。停在標誌與反覆重新啟動是不同症狀，請記錄您看到的情況。</li><li>若再次進入 Recovery 或仍卡住，請拍照給客服。不要把物品插入插孔，或使用其他型號的復原程序。恢復出廠設定會刪除 App、帳號與設定，請先取得型號對應指引。</li></ol>',
                ],
                'firmware' => [
                    'title' => '找不到韌體更新或更新失敗',
                    'copy' => '<ol><li>在網路正常時，使用盒子提供的系統更新功能。選單名稱可能因韌體版本不同而異。</li><li>更新中保持供電。請勿安裝其他型號的韌體。</li><li>沒有顯示更新，不代表一定是最新版本。不確定時，請提供 15P 型號、目前版本與錯誤照片給客服，不要反覆重試失敗的更新。</li></ol>',
                ],
                'download_ssl' => [
                    'title' => 'Yogurt TV 下載失敗或顯示 SSL 錯誤',
                    'copy' => '<ol><li>檢查網路及盒子的日期時間。使用 App 安裝指南，或請客服確認目前安裝網址；不要使用來路不明的 APK。</li><li>若網頁能開但下載失敗，可在行動數據額度允許時試一次手機熱點。此方式曾解決舊型號客服案例，但不能保證解決 15P 問題。</li><li>若熱點成功但家中 Wi-Fi 失敗，可向路由器或網路業者客服查詢安全警示，仍不能據此確定原因。不要因下載錯誤反覆恢復出廠設定；請提供完整錯誤及測試結果。</li></ol>',
                ],
                'optical_fit' => [
                    'title' => '光纖音訊線插不穩',
                    'copy' => '<ol><li>TOSLINK 是光纖音訊連接。確認接頭方向並取下保護帽，再輕輕插入；請勿用力硬推。</li><li>若手邊已有另一條標準 TOSLINK 線，只在完好的插孔輕試。不必為排查特地買線。</li><li>若擋片鬆脫、接頭無法固定或插孔看似損壞，請停止並提供插孔與接頭照片。不要自行裝回擋片，也不要假設換機一定能解決插合問題。</li></ol>',
                ],
                'yogurt_mo' => [
                    'title' => 'Android 手機或平板使用 Yogurt Mo',
                    'copy' => '<ol><li>Yogurt Mo 行動觀看是 15P 功能，不適用 8P 或 10 系列的安裝流程。支援相容的 Android 手機及平板，不支援 iPhone 或 iPad。</li><li>在 15P 開啟 Yogurt TV，選擇 Bind（綁定），再用要使用的 Android 手機或平板掃描 QR 碼。設備請連接同一家庭網路。</li><li>若綁定失敗，請提供 Android 版本與錯誤給客服。不要公開授權資訊或 QR 碼。</li></ol>',
                ],
            ],
        ],
        'resources' => [
            ...
            'items' => [
                'why' => [
                    ...
                    'copy'  => '了解正版來源、禮賓服務與美國保固如何讓你安心選購 10 系列機種。',
                ],
                'channels' => [
                    'title' => '授權內容檢查清單',
            ...
            'articles' => [
                ...
                'why' => [
                    'title'   => '為什麼要在 SVICLOUDTVBOX.US 購買',
                    'lead'    => '保證正版小雲電視盒 10 系列機種、禮賓安裝與一年美國保固，全程提供中英雙語客服。',
                    'updated' => '更新：2025 年 1 月 15 日',
                    'sections' => [
                        'fulfillment' => [
                            'heading' => '內華達州現貨，配送前完成驗證',
                            'body'    => '<p>所有小雲電視盒 10P+ 與 10S 皆由內華達州庫存備貨，檢查序號、封條與最新韌體後才寄出，並提供物流追蹤碼。</p>
<ul>
...
<ul>
  ...
  <li>安裝完成後持續協助韌體更新與問題排解。</li>
                        ...
                        'billing' => [
                            'heading' => '安全結帳，價格透明',
                            'body'    => '<p>網站採用 SSL 安全結帳，支援信用卡與 PayPal，依法開立銷售稅。價格透明，結帳畫面即會顯示運費與稅額，並附上物流追蹤碼。</p>
<ul>
  <li>無額外的處理費或盒裝加價。</li>
  <li>一次購買終身使用，沒有月費或自動續約。</li>
  <li>配送後立即寄送收據與追蹤碼，方便掌握物流。</li>
</ul>',
                        ],
                        'next_steps' => [
                            'heading' => '下單後的下一步',
...
<ul>
  ...
  <li>想要禮賓服務與最新韌體，但預算更精簡。</li>
    ...
    'product' => [
        'hero' => [
            'subtitle' => '美國倉庫配送，提供中英文專人安裝服務。',
            'detail'   => '安全結帳 • 美國免運 • 英/中文客服',
            'reassurance' => [
                'badge' => '安心下單',
                'title' => '結帳後的流程一樣清楚',
                'copy'  => '今天下單後，後續細節我們會接手處理：安全付款、可追蹤出貨，以及需要時提供中英雙語安裝協助。',
                'bullets' => [
                    'shipping'  => '內華達州現貨美國免運，出貨後會以 email 提供追蹤編號',
                    'warranty'  => '附 1 年美國保固與 14 天退換貨，由禮賓客服協助處理',
                    'concierge' => '首次安裝、Wi‑Fi 調校與遙控器配對皆可提供英/中文支援',
                ],
            ],
        ],
        'highlights' => [
        ...
        'traffic' => [
            'badge' => '為在美華人／亞洲家庭打造',
            'title' => '美國現貨、雙語禮賓與完整保固支援',
            'lead'  => '服務在美華人／亞洲家庭：內華達倉 48 小時出貨，中文/English 禮賓代客設定，提供適合 4K 體育、追劇與日常串流的正版 SVICLOUD 硬體。',
            'bullets' => [
                'shipping'  => '48 小時美國出貨，附在地電源/HDMI 與追蹤編號',
                'concierge' => '雙語禮賓：遠端設定、Wi-Fi 調校與裝置使用指引',
                'warranty'  => '1 年美國保固 + 14 天退換貨，禮賓全程協助',
            ],
            'links' => [
                'compare' => '比較 10P+ 與 10S',
        ...
        'faq' => [
            'badge' => '常見問題',
            'title' => '購買前最常問的 3 個問題',
            'lead'  => '配送時程、保固退換與中文安裝協助。',
            'items' => [
                'shipping' => [
                    'q' => '美國/加拿大出貨速度多久？',
                    'a' => '太平洋時間下午 2 點前下單，48 小時內由內華達倉用 USPS/UPS/FedEx 寄出。加拿大通常 5–7 個工作天（含報關）。',
                ],
                'warranty' => [
                    'q' => '包含什麼保固與退換貨？',
                    'a' => 'SVICLOUDTVBOX.US 全站皆含 1 年美國硬體保固與 14 天退換貨。提供訂單編號即可由禮賓協助排除故障、換貨或退貨。',
                ],
                'concierge' => [
                    'q' => '可以用中文協助我安裝嗎？',
            ...
            'sections' => [
                'device_models' => [
                    ...
                    'items' => [
                        ...
                        'box_contents' => [
                            'question' => '盒裝有哪些配件？',
                            'answer'   => '主機、美規電源供應器、HDMI 線、藍牙語音遙控器、快速入門指南。',
                        ],
                    ],
                ],
                'setup_activation' => [
