...
return [
    ...
    'footer' => [
        ...
        'benefits'  => [
            'shipping'  => [
                'label'       => '48 小時內美國出貨',
                'description' => '大多數訂單於兩個工作天內由加州倉庫出貨。',
            ],
            'dealer'    => [
                'label'       => '官方授權經銷商',
                ...
                'orders' => [
                    ...
                    'items' => [
                        'fulfillment' => [
                            ...
                            'answer'   => '美西時間下午 2 點前成立的訂單，48 小時內由加州倉庫以 USPS、UPS 或 FedEx 出貨，寄出後會自動寄送追蹤碼。寄往加拿大通常 5–7 個工作天（含清關時間）。',
                        ],
                        'warranty' => [
    ...
    'products' => [
        'svicloud-10p-plus' => [
            ...
            'description' => '<p>小雲電視盒 10P+ 是家庭客廳的旗艦機，結合語音操控、卡拉 OK 與最快的硬體效能。</p><ul><li>4GB 記憶體與 64GB 儲存、AV1 解碼，直播體育賽事與戲劇都能流暢 4K 播放。</li><li>內建兒童模式與卡拉 OK 應用，附英文 / 中文禮賓帶領完成設定。</li><li>標配 Wi-Fi 6、Gigabit 有線網路、藍牙語音遙控、USB 3.0 與擴充埠，滿足多種安裝情境。</li><li>美國加州倉庫出貨，30 天安心退換、一年美國保固與真人禮賓客服。</li></ul><p>盒內附 HDMI 線、電源供應器、語音遙控，支援雙無線麥克風卡拉 OK。</p>',
        ],
        'svicloud-10s' => [
    ...
    'about' => [
        'hero' => [
            ...
            'lead'          => '我們是 168 Media Group LLC，駐點加州的中文電視盒顧問團隊，提供美國本地庫存、中英雙語安裝服務與快速售後支援。',
            'cta'           => '預約禮賓客服',
