...
return [
    ...
    'frontpage' => [
        ...
        'accessories' => [
            'badge'    => '配件',
            'title'    => '升級你的設置',
            'subtitle' => '以官方藍牙遙控器讓 10P+ 體驗更完整 — 單獨販售，從內華達州出貨。',
            'product'  => [
                'badge'   => '新品',
                'title'   => '小雲電視盒 10P+ 藍牙電視遙控器',
                'copy'    => '專為 SVICLOUD 10P+ 設計的官方替換或備用藍牙語音遙控。幾秒完成配對，支援語音搜尋，並可控制電視音量與開關機。',
                'features' => [
                    'bt'     => 'Bluetooth 5.0 — 快速、穩定配對',
                    'voice'  => '內建麥克風支援語音搜尋與助理指令',
                    'compat' => '通用電視開關機與音量控制鍵',
                ],
                'cta'         => '選購遙控器',
                'details_cta' => '查看詳情',
                'price_note'  => '從內華達州出貨 · 美國免運費',
            ],
        ],
    ],
    'shop' => [
    ...
    'products' => [
        ...
        'svicloud-bluetooth-remote-10p-plus' => [
            'short_description' => '小雲電視盒 10P+ 官方藍牙遙控器。Bluetooth 5.0 配對、語音搜尋麥克風與通用電視開關機/音量鍵。美國現貨出貨。',
            'description' => '<p>小雲電視盒 10P+ 藍牙電視遙控器是專為多人共用電視家庭設計的官方替換或備用遙控器。只需按住 VOL- 和 VOL+ 按鈕，幾秒內即可與 10P+ 完成配對，無需額外 App 或設定畫面。</p><ul><li>Bluetooth 5.0 提供最遠 10 公尺的快速、穩定配對體驗。</li><li>內建麥克風支援語音搜尋指令與助理快捷鍵。</li><li>通用電視鍵可直接從遙控器控制電視開關機、音量與輸入來源。</li><li>背光數字鍵盤與媒體鍵讓夜間操作更舒適。</li><li>僅適用於 SVICLOUD 10P+。從內華達州出貨，美國境內免費配送。</li></ul>',
            'best_for' => [
                'badge' => '最適合',
                'title' => '需要替換或備用遙控器的 10P+ 用戶',
                'copy'  => '為多人共用電視的家庭配備一支備用遙控，或以完全相同的藍牙語音遙控取代遺失的那支。',
                'bullets' => [
                    'primary'   => '與 10P+ 隨附遙控完全相同的替換品',
                    'secondary' => '非常適合多人共用同一台電視的家庭',
                    'tertiary'  => '美國免運費出貨，享有標準退換貨保障',
                ],
            ],
        ],
        'svicloud-10s' => [
    ...
    'compare' => [
        'meta' => [
            'title'       => '小雲盒子 10P+ 和 10S 比較｜美國購買前先看規格差異',
            'description' => '比較小雲盒子 10P+ 與 10S 的規格、功能、價格與適用情境，幫你在美國購買前快速選出最適合的機型。',
