...
return [
    ...
    'guides' => [
        ...
        'apps' => [
            ...
            'lead'  => '如果找不到 App、App 無法開啟，或第一次設定後需要重新安裝，請依照這份公開清單操作。客戶專屬的安裝來源與代碼，請查看下單後收到的設定教學 Email。',
            'items' => [
                'internet' => [
                    'title' => '1. 確認電視盒已連上網路',
                    'copy'  => '打開「設定 → 網路」，確認 Wi-Fi 或 Ethernet 顯示已連線。若網路不穩，請先重啟路由器或改用網路線。',
                ],
                'installer' => [
                    'title' => '2. 開啟內建瀏覽器或安裝器',
                    'copy'  => '從主畫面開啟內建瀏覽器、App 市場、App 中心，或客戶設定 Email 內指定的安裝器。請不要使用搜尋結果中的陌生下載連結。',
                ],
                'search' => [
                    'title' => '3. 依照客戶設定 Email 操作',
                    'copy'  => '下單後的設定 Email 會提供客戶專屬安裝來源與正確 App 名稱（如訂單需要）。請完全照著輸入，安裝前確認 App 圖示。',
                ],
                'install' => [
                    'title' => '4. 安裝或更新 App',
                    'copy'  => '選擇 Install 或 Update，等待進度完成後再回到主畫面。安裝過程中請不要拔電源。',
                ],
                'open' => [
                    'title' => '5. 開啟 App 並完成第一次啟動',
                    'copy'  => '第一次開啟 App 時，依畫面提示允許必要權限並完成初始設定。若畫面要求帳號或啟用資訊，請依照客戶 Email 內的說明操作。',
                ],
                'support' => [
                    'title' => '6. 還是卡住？請拍照給客服',
                    'copy'  => '如果 App 無法安裝或出現錯誤訊息，請直接回覆設定 Email，附上電視畫面照片與訂單編號，我們會協助判斷。',
                ],
            ],
        ],
        'post_setup' => [
