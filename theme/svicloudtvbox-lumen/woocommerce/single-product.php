...
while (have_posts()) :
    ...
    if ($is_15p_product && function_exists('svic_15p_remote_image_html')) {
        ...
        $primary_image_html = '<img class="product-hero-image" src="' . esc_url(svic_theme_image_uri('/assets/images/products/svicloud-15p-primary-studio-v3-remote-watermarked.webp')) . '" alt="' . esc_attr($localized_product_title) . '" />';
    } else {
