...
$hero_15p_artwork = svic_get_theme_image_meta('/assets/images/products/svicloud-15p-marketing-v4.webp');
...
$pricing_card_images = [
    '15p' => array_merge(
        ...
        svic_get_theme_image_meta('/assets/images/products/svicloud-15p-marketing-v4.webp')
    ),
    '10p' => array_merge(
