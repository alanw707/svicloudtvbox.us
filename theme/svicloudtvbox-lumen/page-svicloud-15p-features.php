...
$image_meta = function_exists('svic_get_theme_image_meta') ? svic_get_theme_image_meta('/assets/images/products/svicloud-15p-marketing-v5-watermarked.webp') : [];
$image_url = $image_meta['url'] ?? get_template_directory_uri() . '/assets/images/products/svicloud-15p-marketing-v5-watermarked.webp';
