...
while (have_posts()) :
    ...
    if (!$product) {
        echo '<main class="page-shell"><p class="woocommerce-info">' . esc_html__('Product unavailable.', 'svicloudtvbox') . '</p></main>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        do_action('woocommerce_after_single_product');
        continue;
    }
    ...
    <main class="page-shell">
      ...
      <section class="product-description">
        <h2 class="h3 spacing-normal"><?php echo esc_html__('Description', 'svicloudtvbox'); ?></h2>
