...
function svic_fixture_import_local_15p(array &$maps): void {
    $media = array(
        'primary_studio' => array('path' => 'assets/images/products/svicloud-15p-primary-studio-v3-remote-watermarked.webp', 'title' => 'SVICLOUD 15P studio product image with remote', 'alt' => 'SVICLOUD 15P TV Box front studio view with Bluetooth voice remote'),
        ...
        'marketing_feature' => array('path' => 'assets/images/products/svicloud-15p-marketing-v6-remote-watermarked.webp', 'title' => 'SVICLOUD 15P in-stock feature graphic with remote', 'alt' => 'SVICLOUD 15P Android 14 in-stock feature graphic with Bluetooth voice remote'),
    );
