...
function svic_fixture_import_local_15p(array &$maps): void {
    $media = array(
        'primary_studio' => array('path' => 'assets/images/products/svicloud-15p-primary-studio-v4-bilingual-remote-watermarked.webp', 'title' => 'SVICLOUD 15P bilingual studio product image with remote', 'alt' => 'SVICLOUD 小雲盒子 15P TV Box front studio view with Bluetooth voice remote'),
        'angle_studio' => array('path' => 'assets/images/products/svicloud-15p-angle-studio-v4-bilingual-remote-watermarked.webp', 'title' => 'SVICLOUD 15P bilingual angled studio view with remote', 'alt' => 'SVICLOUD 15P 小雲盒子 TV box angled view with Bluetooth voice remote'),
        'lifestyle_studio' => array('path' => 'assets/images/products/svicloud-15p-lifestyle-studio-v3-remote-watermarked.webp', 'title' => 'SVICLOUD 15P media console studio image with remote', 'alt' => 'SVICLOUD 15P TV Box on media console with Bluetooth voice remote'),
        'detail_studio' => array('path' => 'assets/images/products/svicloud-15p-detail-studio-v3-remote-watermarked.webp', 'title' => 'SVICLOUD 15P front detail studio image with remote', 'alt' => 'SVICLOUD 15P TV Box front detail view with Bluetooth voice remote'),
        'marketing_feature' => array('path' => 'assets/images/products/svicloud-15p-marketing-v7-bilingual-remote-watermarked.webp', 'title' => 'SVICLOUD 15P bilingual in-stock feature graphic with remote', 'alt' => 'SVICLOUD 小雲盒子 15P Android 14 in-stock feature graphic with Bluetooth voice remote'),
    );
