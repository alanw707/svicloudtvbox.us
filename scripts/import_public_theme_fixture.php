...
function svic_fixture_import_local_15p(array &$maps): void {
    $media = array(
        ...
        'angle_studio' => array('path' => 'assets/images/products/svicloud-15p-angle-studio-v3-remote-watermarked.webp', 'title' => 'SVICLOUD 15P angled studio view with remote', 'alt' => 'SVICLOUD 15P TV box angled view with Bluetooth voice remote'),
